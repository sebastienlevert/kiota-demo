...
export class Newprocess extends Crmbaseentity implements Parsable {
    ...
    private _newProcess_ProcessSessions?: Processsession[] | undefined;
    private _newProcess_SyncErrors?: Syncerror[] | undefined;
    ...
    private _workflowlogs_newprocess?: Workflowlog[] | undefined;
    /**
    ...
    /**
     * Instantiates a new newprocess and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "_activestageid_value": (o, n) => { (o as unknown as Newprocess)._activestageid_value = n.getStringValue(); },
            "_createdby_value": (o, n) => { (o as unknown as Newprocess)._createdby_value = n.getStringValue(); },
            "_createdonbehalfby_value": (o, n) => { (o as unknown as Newprocess)._createdonbehalfby_value = n.getStringValue(); },
            "_knowledgearticleid_value": (o, n) => { (o as unknown as Newprocess)._knowledgearticleid_value = n.getStringValue(); },
            "_modifiedby_value": (o, n) => { (o as unknown as Newprocess)._modifiedby_value = n.getStringValue(); },
            "_modifiedonbehalfby_value": (o, n) => { (o as unknown as Newprocess)._modifiedonbehalfby_value = n.getStringValue(); },
            "_organizationid_value": (o, n) => { (o as unknown as Newprocess)._organizationid_value = n.getStringValue(); },
            "_processid_value": (o, n) => { (o as unknown as Newprocess)._processid_value = n.getStringValue(); },
            "_transactioncurrencyid_value": (o, n) => { (o as unknown as Newprocess)._transactioncurrencyid_value = n.getStringValue(); },
            "activestageid": (o, n) => { (o as unknown as Newprocess).activestageid = n.getObjectValue<Processstage>(createProcessstageFromDiscriminatorValue); },
            "activestagestartedon": (o, n) => { (o as unknown as Newprocess).activestagestartedon = n.getDateValue(); },
            "businessprocessflowinstanceid": (o, n) => { (o as unknown as Newprocess).businessprocessflowinstanceid = n.getStringValue(); },
            "completedon": (o, n) => { (o as unknown as Newprocess).completedon = n.getDateValue(); },
            "createdbyname": (o, n) => { (o as unknown as Newprocess).createdbyname = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "createdon": (o, n) => { (o as unknown as Newprocess).createdon = n.getDateValue(); },
            "createdonbehalfbyname": (o, n) => { (o as unknown as Newprocess).createdonbehalfbyname = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "duration": (o, n) => { (o as unknown as Newprocess).duration = n.getNumberValue(); },
            "exchangerate": (o, n) => { (o as unknown as Newprocess).exchangerate = n.getNumberValue(); },
            "importsequencenumber": (o, n) => { (o as unknown as Newprocess).importsequencenumber = n.getNumberValue(); },
            "knowledgearticleid": (o, n) => { (o as unknown as Newprocess).knowledgearticleid = n.getObjectValue<Knowledgearticle>(createKnowledgearticleFromDiscriminatorValue); },
            "modifiedbyname": (o, n) => { (o as unknown as Newprocess).modifiedbyname = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "modifiedon": (o, n) => { (o as unknown as Newprocess).modifiedon = n.getDateValue(); },
            "modifiedonbehalfbyname": (o, n) => { (o as unknown as Newprocess).modifiedonbehalfbyname = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "name": (o, n) => { (o as unknown as Newprocess).name = n.getStringValue(); },
            "newProcess_ProcessSessions": (o, n) => { (o as unknown as Newprocess).newProcess_ProcessSessions = n.getCollectionOfObjectValues<Processsession>(createProcesssessionFromDiscriminatorValue); },
            "newProcess_SyncErrors": (o, n) => { (o as unknown as Newprocess).newProcess_SyncErrors = n.getCollectionOfObjectValues<Syncerror>(createSyncerrorFromDiscriminatorValue); },
            "organizationid": (o, n) => { (o as unknown as Newprocess).organizationid = n.getObjectValue<Organization>(createOrganizationFromDiscriminatorValue); },
            "overriddencreatedon": (o, n) => { (o as unknown as Newprocess).overriddencreatedon = n.getDateValue(); },
            "processid": (o, n) => { (o as unknown as Newprocess).processid = n.getObjectValue<Workflow>(createWorkflowFromDiscriminatorValue); },
            "statecode": (o, n) => { (o as unknown as Newprocess).statecode = n.getNumberValue(); },
            "statuscode": (o, n) => { (o as unknown as Newprocess).statuscode = n.getNumberValue(); },
            "transactioncurrencyid": (o, n) => { (o as unknown as Newprocess).transactioncurrencyid = n.getObjectValue<Transactioncurrency>(createTransactioncurrencyFromDiscriminatorValue); },
            "traversedpath": (o, n) => { (o as unknown as Newprocess).traversedpath = n.getStringValue(); },
            "versionnumber": (o, n) => { (o as unknown as Newprocess).versionnumber = n.getNumberValue(); },
            "workflowlogs_newprocess": (o, n) => { (o as unknown as Newprocess).workflowlogs_newprocess = n.getCollectionOfObjectValues<Workflowlog>(createWorkflowlogFromDiscriminatorValue); },
        };
    };
    /**
    ...
    /**
     * Gets the newProcess_ProcessSessions property value. 
     * @returns a processsession
     */
    public get newProcess_ProcessSessions() {
        return this._newProcess_ProcessSessions;
    };
    /**
     * Sets the newProcess_ProcessSessions property value. 
     * @param value Value to set for the NewProcess_ProcessSessions property.
     */
    public set newProcess_ProcessSessions(value: Processsession[] | undefined) {
        this._newProcess_ProcessSessions = value;
    };
    /**
     * Gets the newProcess_SyncErrors property value. 
     * @returns a syncerror
     */
    public get newProcess_SyncErrors() {
        return this._newProcess_SyncErrors;
    };
    /**
     * Sets the newProcess_SyncErrors property value. 
     * @param value Value to set for the NewProcess_SyncErrors property.
     */
    public set newProcess_SyncErrors(value: Syncerror[] | undefined) {
        this._newProcess_SyncErrors = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Processsession>("newProcess_ProcessSessions", this.newProcess_ProcessSessions);
        writer.writeCollectionOfObjectValues<Syncerror>("newProcess_SyncErrors", this.newProcess_SyncErrors);
        ...
        writer.writeCollectionOfObjectValues<Workflowlog>("workflowlogs_newprocess", this.workflowlogs_newprocess);
    };
    /**
    ...
    /**
     * Gets the workflowlogs_newprocess property value. 
     * @returns a workflowlog
     */
    public get workflowlogs_newprocess() {
        return this._workflowlogs_newprocess;
    };
    /**
     * Sets the workflowlogs_newprocess property value. 
     * @param value Value to set for the workflowlogs_newprocess property.
     */
    public set workflowlogs_newprocess(value: Workflowlog[] | undefined) {
        this._workflowlogs_newprocess = value;
    };
}
