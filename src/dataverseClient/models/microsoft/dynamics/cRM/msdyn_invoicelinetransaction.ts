...
import {Account, Annotation, Asyncoperation, Bookableresource, Bookableresourcecategory, Bulkdeletefailure, Businessunit, Contact, Crmbaseentity, Duplicaterecord, Invoice, Invoicedetail, Mailboxtrackingfolder, Msdyn_organizationalunit, Msdyn_project, Msdyn_projecttask, Msdyn_transactioncategory, Pricelevel, Principal, Principalobjectattributeaccess, Processsession, Product, Salesorder, Salesorderdetail, Syncerror, Systemuser, Team, Transactioncurrency, Uom, Uomschedule} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Msdyn_invoicelinetransaction extends Crmbaseentity implements Parsable {
    ...
    private __msdyn_invoicelineid_value?: string | undefined;
    private __msdyn_originalinvoicelinedetail_value?: string | undefined;
    ...
    private _msdyn_correction?: boolean | undefined;
    ...
    private _msdyn_invoiceamount?: number | undefined;
    private _msdyn_invoiceamount_base?: number | undefined;
    private _msdyn_invoiceline?: string | undefined;
    private _msdyn_InvoiceLineId?: Invoicedetail | undefined;
    private _msdyn_invoicelinetransaction_Annotations?: Annotation[] | undefined;
    private _msdyn_invoicelinetransaction_AsyncOperations?: Asyncoperation[] | undefined;
    private _msdyn_invoicelinetransaction_BulkDeleteFailures?: Bulkdeletefailure[] | undefined;
    private _msdyn_invoicelinetransaction_DuplicateBaseRecord?: Duplicaterecord[] | undefined;
    private _msdyn_invoicelinetransaction_DuplicateMatchingRecord?: Duplicaterecord[] | undefined;
    private _msdyn_invoicelinetransaction_MailboxTrackingFolders?: Mailboxtrackingfolder[] | undefined;
    private _msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses?: Principalobjectattributeaccess[] | undefined;
    private _msdyn_invoicelinetransaction_ProcessSession?: Processsession[] | undefined;
    private _msdyn_invoicelinetransaction_SyncErrors?: Syncerror[] | undefined;
    private _msdyn_invoicelinetransactionid?: string | undefined;
    private _msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail?: Msdyn_invoicelinetransaction[] | undefined;
    private _msdyn_OriginalInvoiceLineDetail?: Msdyn_invoicelinetransaction | undefined;
    private _msdyn_percent?: number | undefined;
    private _msdyn_previousamount?: number | undefined;
    private _msdyn_previousamount_base?: number | undefined;
    ...
    /**
     * Gets the _msdyn_invoicelineid_value property value. 
     * @returns a string
     */
    public get _msdyn_invoicelineid_value() {
        return this.__msdyn_invoicelineid_value;
    };
    /**
     * Sets the _msdyn_invoicelineid_value property value. 
     * @param value Value to set for the _msdyn_invoicelineid_value property.
     */
    public set _msdyn_invoicelineid_value(value: string | undefined) {
        this.__msdyn_invoicelineid_value = value;
    };
    /**
     * Gets the _msdyn_originalinvoicelinedetail_value property value. 
     * @returns a string
     */
    public get _msdyn_originalinvoicelinedetail_value() {
        return this.__msdyn_originalinvoicelinedetail_value;
    };
    /**
     * Sets the _msdyn_originalinvoicelinedetail_value property value. 
     * @param value Value to set for the _msdyn_originalinvoicelinedetail_value property.
     */
    public set _msdyn_originalinvoicelinedetail_value(value: string | undefined) {
        this.__msdyn_originalinvoicelinedetail_value = value;
    };
    /**
    ...
    /**
     * Instantiates a new msdyn_invoicelinetransaction and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "_createdby_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._createdby_value = n.getStringValue(); },
            "_createdonbehalfby_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._createdonbehalfby_value = n.getStringValue(); },
            "_modifiedby_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._modifiedby_value = n.getStringValue(); },
            "_modifiedonbehalfby_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._modifiedonbehalfby_value = n.getStringValue(); },
            "_msdyn_accountcustomer_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_accountcustomer_value = n.getStringValue(); },
            "_msdyn_accountvendor_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_accountvendor_value = n.getStringValue(); },
            "_msdyn_bookableresource_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_bookableresource_value = n.getStringValue(); },
            "_msdyn_contactcustomer_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_contactcustomer_value = n.getStringValue(); },
            "_msdyn_contactvendor_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_contactvendor_value = n.getStringValue(); },
            "_msdyn_contractorganizationalunitid_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_contractorganizationalunitid_value = n.getStringValue(); },
            "_msdyn_invoice_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_invoice_value = n.getStringValue(); },
            "_msdyn_invoicelineid_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_invoicelineid_value = n.getStringValue(); },
            "_msdyn_originalinvoicelinedetail_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_originalinvoicelinedetail_value = n.getStringValue(); },
            "_msdyn_pricelist_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_pricelist_value = n.getStringValue(); },
            "_msdyn_product_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_product_value = n.getStringValue(); },
            "_msdyn_project_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_project_value = n.getStringValue(); },
            "_msdyn_resourcecategory_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_resourcecategory_value = n.getStringValue(); },
            "_msdyn_resourceorganizationalunitid_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_resourceorganizationalunitid_value = n.getStringValue(); },
            "_msdyn_salescontract_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_salescontract_value = n.getStringValue(); },
            "_msdyn_salescontractlineid_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_salescontractlineid_value = n.getStringValue(); },
            "_msdyn_task_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_task_value = n.getStringValue(); },
            "_msdyn_transactioncategory_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_transactioncategory_value = n.getStringValue(); },
            "_msdyn_unit_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_unit_value = n.getStringValue(); },
            "_msdyn_unitschedule_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._msdyn_unitschedule_value = n.getStringValue(); },
            "_ownerid_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._ownerid_value = n.getStringValue(); },
            "_owningbusinessunit_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._owningbusinessunit_value = n.getStringValue(); },
            "_owningteam_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._owningteam_value = n.getStringValue(); },
            "_owninguser_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._owninguser_value = n.getStringValue(); },
            "_transactioncurrencyid_value": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction)._transactioncurrencyid_value = n.getStringValue(); },
            "createdby": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).createdby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "createdon": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).createdon = n.getDateValue(); },
            "createdonbehalfby": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).createdonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "exchangerate": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).exchangerate = n.getNumberValue(); },
            "importsequencenumber": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).importsequencenumber = n.getNumberValue(); },
            "modifiedby": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).modifiedby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "modifiedon": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).modifiedon = n.getDateValue(); },
            "modifiedonbehalfby": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).modifiedonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "msdyn_AccountCustomer": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_AccountCustomer = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_accountingdate": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_accountingdate = n.getDateValue(); },
            "msdyn_AccountVendor": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_AccountVendor = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_amount": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_amount = n.getNumberValue(); },
            "msdyn_amount_base": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_amount_base = n.getNumberValue(); },
            "msdyn_amountmethod": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_amountmethod = n.getNumberValue(); },
            "msdyn_basisamount": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_basisamount = n.getNumberValue(); },
            "msdyn_basisamount_base": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_basisamount_base = n.getNumberValue(); },
            "msdyn_basisprice": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_basisprice = n.getNumberValue(); },
            "msdyn_basisprice_base": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_basisprice_base = n.getNumberValue(); },
            "msdyn_basisquantity": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_basisquantity = n.getNumberValue(); },
            "msdyn_billingtype": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_billingtype = n.getNumberValue(); },
            "msdyn_bookableresource": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_bookableresource = n.getObjectValue<Bookableresource>(createBookableresourceFromDiscriminatorValue); },
            "msdyn_ContactCustomer": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_ContactCustomer = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_ContactVendor": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_ContactVendor = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_contractorganizationalunitid": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_contractorganizationalunitid = n.getObjectValue<Msdyn_organizationalunit>(createMsdyn_organizationalunitFromDiscriminatorValue); },
            "msdyn_correction": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_correction = n.getBooleanValue(); },
            "msdyn_customertype": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_customertype = n.getNumberValue(); },
            "msdyn_description": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_description = n.getStringValue(); },
            "msdyn_documentdate": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_documentdate = n.getDateValue(); },
            "msdyn_enddatetime": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_enddatetime = n.getDateValue(); },
            "msdyn_exchangeratedate": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_exchangeratedate = n.getDateValue(); },
            "msdyn_externaldescription": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_externaldescription = n.getStringValue(); },
            "msdyn_Invoice": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_Invoice = n.getObjectValue<Invoice>(createInvoiceFromDiscriminatorValue); },
            "msdyn_invoiceamount": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoiceamount = n.getNumberValue(); },
            "msdyn_invoiceamount_base": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoiceamount_base = n.getNumberValue(); },
            "msdyn_invoiceline": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoiceline = n.getStringValue(); },
            "msdyn_InvoiceLineId": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_InvoiceLineId = n.getObjectValue<Invoicedetail>(createInvoicedetailFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_Annotations": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_Annotations = n.getCollectionOfObjectValues<Annotation>(createAnnotationFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_AsyncOperations": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_AsyncOperations = n.getCollectionOfObjectValues<Asyncoperation>(createAsyncoperationFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_BulkDeleteFailures": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_BulkDeleteFailures = n.getCollectionOfObjectValues<Bulkdeletefailure>(createBulkdeletefailureFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_DuplicateBaseRecord": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_DuplicateBaseRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_DuplicateMatchingRecord": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_DuplicateMatchingRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_MailboxTrackingFolders": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_MailboxTrackingFolders = n.getCollectionOfObjectValues<Mailboxtrackingfolder>(createMailboxtrackingfolderFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses = n.getCollectionOfObjectValues<Principalobjectattributeaccess>(createPrincipalobjectattributeaccessFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_ProcessSession": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_ProcessSession = n.getCollectionOfObjectValues<Processsession>(createProcesssessionFromDiscriminatorValue); },
            "msdyn_invoicelinetransaction_SyncErrors": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransaction_SyncErrors = n.getCollectionOfObjectValues<Syncerror>(createSyncerrorFromDiscriminatorValue); },
            "msdyn_invoicelinetransactionid": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_invoicelinetransactionid = n.getStringValue(); },
            "msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail = n.getCollectionOfObjectValues<Msdyn_invoicelinetransaction>(createMsdyn_invoicelinetransactionFromDiscriminatorValue); },
            "msdyn_OriginalInvoiceLineDetail": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_OriginalInvoiceLineDetail = n.getObjectValue<Msdyn_invoicelinetransaction>(createMsdyn_invoicelinetransactionFromDiscriminatorValue); },
            "msdyn_percent": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_percent = n.getNumberValue(); },
            "msdyn_previousamount": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_previousamount = n.getNumberValue(); },
            "msdyn_previousamount_base": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_previousamount_base = n.getNumberValue(); },
            "msdyn_price": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_price = n.getNumberValue(); },
            "msdyn_price_base": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_price_base = n.getNumberValue(); },
            "msdyn_PriceList": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_PriceList = n.getObjectValue<Pricelevel>(createPricelevelFromDiscriminatorValue); },
            "msdyn_Product": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_Product = n.getObjectValue<Product>(createProductFromDiscriminatorValue); },
            "msdyn_Project": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_Project = n.getObjectValue<Msdyn_project>(createMsdyn_projectFromDiscriminatorValue); },
            "msdyn_quantity": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_quantity = n.getNumberValue(); },
            "msdyn_ResourceCategory": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_ResourceCategory = n.getObjectValue<Bookableresourcecategory>(createBookableresourcecategoryFromDiscriminatorValue); },
            "msdyn_ResourceOrganizationalUnitId": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_ResourceOrganizationalUnitId = n.getObjectValue<Msdyn_organizationalunit>(createMsdyn_organizationalunitFromDiscriminatorValue); },
            "msdyn_SalesContract": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_SalesContract = n.getObjectValue<Salesorder>(createSalesorderFromDiscriminatorValue); },
            "msdyn_salescontractline": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_salescontractline = n.getStringValue(); },
            "msdyn_SalesContractLineId": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_SalesContractLineId = n.getObjectValue<Salesorderdetail>(createSalesorderdetailFromDiscriminatorValue); },
            "msdyn_startdatetime": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_startdatetime = n.getDateValue(); },
            "msdyn_Task": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_Task = n.getObjectValue<Msdyn_projecttask>(createMsdyn_projecttaskFromDiscriminatorValue); },
            "msdyn_TransactionCategory": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_TransactionCategory = n.getObjectValue<Msdyn_transactioncategory>(createMsdyn_transactioncategoryFromDiscriminatorValue); },
            "msdyn_transactionclassification": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_transactionclassification = n.getNumberValue(); },
            "msdyn_transactiontypecode": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_transactiontypecode = n.getNumberValue(); },
            "msdyn_Unit": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_Unit = n.getObjectValue<Uom>(createUomFromDiscriminatorValue); },
            "msdyn_UnitSchedule": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_UnitSchedule = n.getObjectValue<Uomschedule>(createUomscheduleFromDiscriminatorValue); },
            "msdyn_vendortype": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).msdyn_vendortype = n.getNumberValue(); },
            "overriddencreatedon": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).overriddencreatedon = n.getDateValue(); },
            "ownerid": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).ownerid = n.getObjectValue<Principal>(createPrincipalFromDiscriminatorValue); },
            "owningbusinessunit": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).owningbusinessunit = n.getObjectValue<Businessunit>(createBusinessunitFromDiscriminatorValue); },
            "owningteam": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).owningteam = n.getObjectValue<Team>(createTeamFromDiscriminatorValue); },
            "owninguser": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).owninguser = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "statecode": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).statecode = n.getNumberValue(); },
            "statuscode": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).statuscode = n.getNumberValue(); },
            "timezoneruleversionnumber": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).timezoneruleversionnumber = n.getNumberValue(); },
            "transactioncurrencyid": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).transactioncurrencyid = n.getObjectValue<Transactioncurrency>(createTransactioncurrencyFromDiscriminatorValue); },
            "utcconversiontimezonecode": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).utcconversiontimezonecode = n.getNumberValue(); },
            "versionnumber": (o, n) => { (o as unknown as Msdyn_invoicelinetransaction).versionnumber = n.getNumberValue(); },
        };
    };
    /**
    ...
    /**
     * Gets the msdyn_correction property value. 
     * @returns a boolean
     */
    public get msdyn_correction() {
        return this._msdyn_correction;
    };
    /**
     * Sets the msdyn_correction property value. 
     * @param value Value to set for the msdyn_correction property.
     */
    public set msdyn_correction(value: boolean | undefined) {
        this._msdyn_correction = value;
    };
    /**
    ...
    /**
     * Gets the msdyn_invoiceamount property value. 
     * @returns a int64
     */
    public get msdyn_invoiceamount() {
        return this._msdyn_invoiceamount;
    };
    /**
     * Sets the msdyn_invoiceamount property value. 
     * @param value Value to set for the msdyn_invoiceamount property.
     */
    public set msdyn_invoiceamount(value: number | undefined) {
        this._msdyn_invoiceamount = value;
    };
    /**
     * Gets the msdyn_invoiceamount_base property value. 
     * @returns a int64
     */
    public get msdyn_invoiceamount_base() {
        return this._msdyn_invoiceamount_base;
    };
    /**
     * Sets the msdyn_invoiceamount_base property value. 
     * @param value Value to set for the msdyn_invoiceamount_base property.
     */
    public set msdyn_invoiceamount_base(value: number | undefined) {
        this._msdyn_invoiceamount_base = value;
    };
    /**
     * Gets the msdyn_invoiceline property value. 
     * @returns a string
     */
    public get msdyn_invoiceline() {
        return this._msdyn_invoiceline;
    };
    /**
     * Sets the msdyn_invoiceline property value. 
     * @param value Value to set for the msdyn_invoiceline property.
     */
    public set msdyn_invoiceline(value: string | undefined) {
        this._msdyn_invoiceline = value;
    };
    /**
     * Gets the msdyn_InvoiceLineId property value. 
     * @returns a invoicedetail
     */
    public get msdyn_InvoiceLineId() {
        return this._msdyn_InvoiceLineId;
    };
    /**
     * Sets the msdyn_InvoiceLineId property value. 
     * @param value Value to set for the msdyn_InvoiceLineId property.
     */
    public set msdyn_InvoiceLineId(value: Invoicedetail | undefined) {
        this._msdyn_InvoiceLineId = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_Annotations property value. 
     * @returns a annotation
     */
    public get msdyn_invoicelinetransaction_Annotations() {
        return this._msdyn_invoicelinetransaction_Annotations;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_Annotations property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_Annotations property.
     */
    public set msdyn_invoicelinetransaction_Annotations(value: Annotation[] | undefined) {
        this._msdyn_invoicelinetransaction_Annotations = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_AsyncOperations property value. 
     * @returns a asyncoperation
     */
    public get msdyn_invoicelinetransaction_AsyncOperations() {
        return this._msdyn_invoicelinetransaction_AsyncOperations;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_AsyncOperations property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_AsyncOperations property.
     */
    public set msdyn_invoicelinetransaction_AsyncOperations(value: Asyncoperation[] | undefined) {
        this._msdyn_invoicelinetransaction_AsyncOperations = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_BulkDeleteFailures property value. 
     * @returns a bulkdeletefailure
     */
    public get msdyn_invoicelinetransaction_BulkDeleteFailures() {
        return this._msdyn_invoicelinetransaction_BulkDeleteFailures;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_BulkDeleteFailures property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_BulkDeleteFailures property.
     */
    public set msdyn_invoicelinetransaction_BulkDeleteFailures(value: Bulkdeletefailure[] | undefined) {
        this._msdyn_invoicelinetransaction_BulkDeleteFailures = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_DuplicateBaseRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_invoicelinetransaction_DuplicateBaseRecord() {
        return this._msdyn_invoicelinetransaction_DuplicateBaseRecord;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_DuplicateBaseRecord property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_DuplicateBaseRecord property.
     */
    public set msdyn_invoicelinetransaction_DuplicateBaseRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_invoicelinetransaction_DuplicateBaseRecord = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_DuplicateMatchingRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_invoicelinetransaction_DuplicateMatchingRecord() {
        return this._msdyn_invoicelinetransaction_DuplicateMatchingRecord;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_DuplicateMatchingRecord property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_DuplicateMatchingRecord property.
     */
    public set msdyn_invoicelinetransaction_DuplicateMatchingRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_invoicelinetransaction_DuplicateMatchingRecord = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_MailboxTrackingFolders property value. 
     * @returns a mailboxtrackingfolder
     */
    public get msdyn_invoicelinetransaction_MailboxTrackingFolders() {
        return this._msdyn_invoicelinetransaction_MailboxTrackingFolders;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_MailboxTrackingFolders property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_MailboxTrackingFolders property.
     */
    public set msdyn_invoicelinetransaction_MailboxTrackingFolders(value: Mailboxtrackingfolder[] | undefined) {
        this._msdyn_invoicelinetransaction_MailboxTrackingFolders = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @returns a principalobjectattributeaccess
     */
    public get msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses() {
        return this._msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses property.
     */
    public set msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses(value: Principalobjectattributeaccess[] | undefined) {
        this._msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_ProcessSession property value. 
     * @returns a processsession
     */
    public get msdyn_invoicelinetransaction_ProcessSession() {
        return this._msdyn_invoicelinetransaction_ProcessSession;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_ProcessSession property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_ProcessSession property.
     */
    public set msdyn_invoicelinetransaction_ProcessSession(value: Processsession[] | undefined) {
        this._msdyn_invoicelinetransaction_ProcessSession = value;
    };
    /**
     * Gets the msdyn_invoicelinetransaction_SyncErrors property value. 
     * @returns a syncerror
     */
    public get msdyn_invoicelinetransaction_SyncErrors() {
        return this._msdyn_invoicelinetransaction_SyncErrors;
    };
    /**
     * Sets the msdyn_invoicelinetransaction_SyncErrors property value. 
     * @param value Value to set for the msdyn_invoicelinetransaction_SyncErrors property.
     */
    public set msdyn_invoicelinetransaction_SyncErrors(value: Syncerror[] | undefined) {
        this._msdyn_invoicelinetransaction_SyncErrors = value;
    };
    /**
     * Gets the msdyn_invoicelinetransactionid property value. 
     * @returns a string
     */
    public get msdyn_invoicelinetransactionid() {
        return this._msdyn_invoicelinetransactionid;
    };
    /**
     * Sets the msdyn_invoicelinetransactionid property value. 
     * @param value Value to set for the msdyn_invoicelinetransactionid property.
     */
    public set msdyn_invoicelinetransactionid(value: string | undefined) {
        this._msdyn_invoicelinetransactionid = value;
    };
    /**
     * Gets the msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail property value. 
     * @returns a msdyn_invoicelinetransaction
     */
    public get msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail() {
        return this._msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail;
    };
    /**
     * Sets the msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail property value. 
     * @param value Value to set for the msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail property.
     */
    public set msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail(value: Msdyn_invoicelinetransaction[] | undefined) {
        this._msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail = value;
    };
    /**
     * Gets the msdyn_OriginalInvoiceLineDetail property value. 
     * @returns a msdyn_invoicelinetransaction
     */
    public get msdyn_OriginalInvoiceLineDetail() {
        return this._msdyn_OriginalInvoiceLineDetail;
    };
    /**
     * Sets the msdyn_OriginalInvoiceLineDetail property value. 
     * @param value Value to set for the msdyn_OriginalInvoiceLineDetail property.
     */
    public set msdyn_OriginalInvoiceLineDetail(value: Msdyn_invoicelinetransaction | undefined) {
        this._msdyn_OriginalInvoiceLineDetail = value;
    };
    /**
    ...
    /**
     * Gets the msdyn_previousamount property value. 
     * @returns a int64
     */
    public get msdyn_previousamount() {
        return this._msdyn_previousamount;
    };
    /**
     * Sets the msdyn_previousamount property value. 
     * @param value Value to set for the msdyn_previousamount property.
     */
    public set msdyn_previousamount(value: number | undefined) {
        this._msdyn_previousamount = value;
    };
    /**
     * Gets the msdyn_previousamount_base property value. 
     * @returns a int64
     */
    public get msdyn_previousamount_base() {
        return this._msdyn_previousamount_base;
    };
    /**
     * Sets the msdyn_previousamount_base property value. 
     * @param value Value to set for the msdyn_previousamount_base property.
     */
    public set msdyn_previousamount_base(value: number | undefined) {
        this._msdyn_previousamount_base = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeStringValue("_msdyn_invoicelineid_value", this._msdyn_invoicelineid_value);
        writer.writeStringValue("_msdyn_originalinvoicelinedetail_value", this._msdyn_originalinvoicelinedetail_value);
        ...
        writer.writeBooleanValue("msdyn_correction", this.msdyn_correction);
        ...
        writer.writeNumberValue("msdyn_invoiceamount", this.msdyn_invoiceamount);
        writer.writeNumberValue("msdyn_invoiceamount_base", this.msdyn_invoiceamount_base);
        writer.writeStringValue("msdyn_invoiceline", this.msdyn_invoiceline);
        writer.writeObjectValue<Invoicedetail>("msdyn_InvoiceLineId", this.msdyn_InvoiceLineId);
        writer.writeCollectionOfObjectValues<Annotation>("msdyn_invoicelinetransaction_Annotations", this.msdyn_invoicelinetransaction_Annotations);
        writer.writeCollectionOfObjectValues<Asyncoperation>("msdyn_invoicelinetransaction_AsyncOperations", this.msdyn_invoicelinetransaction_AsyncOperations);
        writer.writeCollectionOfObjectValues<Bulkdeletefailure>("msdyn_invoicelinetransaction_BulkDeleteFailures", this.msdyn_invoicelinetransaction_BulkDeleteFailures);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_invoicelinetransaction_DuplicateBaseRecord", this.msdyn_invoicelinetransaction_DuplicateBaseRecord);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_invoicelinetransaction_DuplicateMatchingRecord", this.msdyn_invoicelinetransaction_DuplicateMatchingRecord);
        writer.writeCollectionOfObjectValues<Mailboxtrackingfolder>("msdyn_invoicelinetransaction_MailboxTrackingFolders", this.msdyn_invoicelinetransaction_MailboxTrackingFolders);
        writer.writeCollectionOfObjectValues<Principalobjectattributeaccess>("msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses", this.msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses);
        writer.writeCollectionOfObjectValues<Processsession>("msdyn_invoicelinetransaction_ProcessSession", this.msdyn_invoicelinetransaction_ProcessSession);
        writer.writeCollectionOfObjectValues<Syncerror>("msdyn_invoicelinetransaction_SyncErrors", this.msdyn_invoicelinetransaction_SyncErrors);
        writer.writeStringValue("msdyn_invoicelinetransactionid", this.msdyn_invoicelinetransactionid);
        writer.writeCollectionOfObjectValues<Msdyn_invoicelinetransaction>("msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail", this.msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail);
        writer.writeObjectValue<Msdyn_invoicelinetransaction>("msdyn_OriginalInvoiceLineDetail", this.msdyn_OriginalInvoiceLineDetail);
        writer.writeNumberValue("msdyn_percent", this.msdyn_percent);
        writer.writeNumberValue("msdyn_previousamount", this.msdyn_previousamount);
        writer.writeNumberValue("msdyn_previousamount_base", this.msdyn_previousamount_base);
