...
import {Account, Annotation, Asyncoperation, Bookableresource, Bookableresourcecategory, Bulkdeletefailure, Businessunit, Contact, Crmbaseentity, Duplicaterecord, Mailboxtrackingfolder, Msdyn_organizationalunit, Msdyn_project, Msdyn_projecttask, Msdyn_transactioncategory, Pricelevel, Principal, Principalobjectattributeaccess, Processsession, Product, Syncerror, Systemuser, Team, Transactioncurrency, Uom, Uomschedule} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Msdyn_opportunitylinetransaction extends Crmbaseentity implements Parsable {
    ...
    private _msdyn_opportunitylinetransaction_Annotations?: Annotation[] | undefined;
    private _msdyn_opportunitylinetransaction_AsyncOperations?: Asyncoperation[] | undefined;
    private _msdyn_opportunitylinetransaction_BulkDeleteFailures?: Bulkdeletefailure[] | undefined;
    private _msdyn_opportunitylinetransaction_DuplicateBaseRecord?: Duplicaterecord[] | undefined;
    private _msdyn_opportunitylinetransaction_DuplicateMatchingRecord?: Duplicaterecord[] | undefined;
    private _msdyn_opportunitylinetransaction_MailboxTrackingFolders?: Mailboxtrackingfolder[] | undefined;
    private _msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses?: Principalobjectattributeaccess[] | undefined;
    private _msdyn_opportunitylinetransaction_ProcessSession?: Processsession[] | undefined;
    private _msdyn_opportunitylinetransaction_SyncErrors?: Syncerror[] | undefined;
    private _msdyn_opportunitylinetransactionid?: string | undefined;
    ...
    /**
     * Instantiates a new msdyn_opportunitylinetransaction and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "_createdby_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._createdby_value = n.getStringValue(); },
            "_createdonbehalfby_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._createdonbehalfby_value = n.getStringValue(); },
            "_modifiedby_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._modifiedby_value = n.getStringValue(); },
            "_modifiedonbehalfby_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._modifiedonbehalfby_value = n.getStringValue(); },
            "_msdyn_accountcustomer_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_accountcustomer_value = n.getStringValue(); },
            "_msdyn_accountvendor_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_accountvendor_value = n.getStringValue(); },
            "_msdyn_bookableresource_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_bookableresource_value = n.getStringValue(); },
            "_msdyn_contactcustomer_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_contactcustomer_value = n.getStringValue(); },
            "_msdyn_contactvendor_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_contactvendor_value = n.getStringValue(); },
            "_msdyn_pricelist_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_pricelist_value = n.getStringValue(); },
            "_msdyn_product_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_product_value = n.getStringValue(); },
            "_msdyn_project_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_project_value = n.getStringValue(); },
            "_msdyn_resourcecategory_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_resourcecategory_value = n.getStringValue(); },
            "_msdyn_resourceorganizationalunitid_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_resourceorganizationalunitid_value = n.getStringValue(); },
            "_msdyn_task_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_task_value = n.getStringValue(); },
            "_msdyn_transactioncategory_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_transactioncategory_value = n.getStringValue(); },
            "_msdyn_unit_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_unit_value = n.getStringValue(); },
            "_msdyn_unitschedule_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._msdyn_unitschedule_value = n.getStringValue(); },
            "_ownerid_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._ownerid_value = n.getStringValue(); },
            "_owningbusinessunit_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._owningbusinessunit_value = n.getStringValue(); },
            "_owningteam_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._owningteam_value = n.getStringValue(); },
            "_owninguser_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._owninguser_value = n.getStringValue(); },
            "_transactioncurrencyid_value": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction)._transactioncurrencyid_value = n.getStringValue(); },
            "createdby": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).createdby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "createdon": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).createdon = n.getDateValue(); },
            "createdonbehalfby": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).createdonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "exchangerate": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).exchangerate = n.getNumberValue(); },
            "importsequencenumber": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).importsequencenumber = n.getNumberValue(); },
            "modifiedby": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).modifiedby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "modifiedon": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).modifiedon = n.getDateValue(); },
            "modifiedonbehalfby": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).modifiedonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "msdyn_AccountCustomer": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_AccountCustomer = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_accountingdate": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_accountingdate = n.getDateValue(); },
            "msdyn_AccountVendor": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_AccountVendor = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_amount": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_amount = n.getNumberValue(); },
            "msdyn_amount_base": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_amount_base = n.getNumberValue(); },
            "msdyn_amountmethod": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_amountmethod = n.getNumberValue(); },
            "msdyn_basisamount": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_basisamount = n.getNumberValue(); },
            "msdyn_basisamount_base": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_basisamount_base = n.getNumberValue(); },
            "msdyn_basisprice": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_basisprice = n.getNumberValue(); },
            "msdyn_basisprice_base": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_basisprice_base = n.getNumberValue(); },
            "msdyn_basisquantity": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_basisquantity = n.getNumberValue(); },
            "msdyn_billingtype": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_billingtype = n.getNumberValue(); },
            "msdyn_bookableresource": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_bookableresource = n.getObjectValue<Bookableresource>(createBookableresourceFromDiscriminatorValue); },
            "msdyn_ContactCustomer": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_ContactCustomer = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_ContactVendor": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_ContactVendor = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_customertype": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_customertype = n.getNumberValue(); },
            "msdyn_description": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_description = n.getStringValue(); },
            "msdyn_documentdate": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_documentdate = n.getDateValue(); },
            "msdyn_enddatetime": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_enddatetime = n.getDateValue(); },
            "msdyn_exchangeratedate": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_exchangeratedate = n.getDateValue(); },
            "msdyn_opportunityline": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunityline = n.getStringValue(); },
            "msdyn_opportunitylinetransaction_Annotations": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_Annotations = n.getCollectionOfObjectValues<Annotation>(createAnnotationFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_AsyncOperations": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_AsyncOperations = n.getCollectionOfObjectValues<Asyncoperation>(createAsyncoperationFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_BulkDeleteFailures": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_BulkDeleteFailures = n.getCollectionOfObjectValues<Bulkdeletefailure>(createBulkdeletefailureFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_DuplicateBaseRecord": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_DuplicateBaseRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_DuplicateMatchingRecord": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_DuplicateMatchingRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_MailboxTrackingFolders": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_MailboxTrackingFolders = n.getCollectionOfObjectValues<Mailboxtrackingfolder>(createMailboxtrackingfolderFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses = n.getCollectionOfObjectValues<Principalobjectattributeaccess>(createPrincipalobjectattributeaccessFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_ProcessSession": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_ProcessSession = n.getCollectionOfObjectValues<Processsession>(createProcesssessionFromDiscriminatorValue); },
            "msdyn_opportunitylinetransaction_SyncErrors": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransaction_SyncErrors = n.getCollectionOfObjectValues<Syncerror>(createSyncerrorFromDiscriminatorValue); },
            "msdyn_opportunitylinetransactionid": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_opportunitylinetransactionid = n.getStringValue(); },
            "msdyn_percent": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_percent = n.getNumberValue(); },
            "msdyn_price": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_price = n.getNumberValue(); },
            "msdyn_price_base": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_price_base = n.getNumberValue(); },
            "msdyn_PriceList": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_PriceList = n.getObjectValue<Pricelevel>(createPricelevelFromDiscriminatorValue); },
            "msdyn_Product": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_Product = n.getObjectValue<Product>(createProductFromDiscriminatorValue); },
            "msdyn_Project": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_Project = n.getObjectValue<Msdyn_project>(createMsdyn_projectFromDiscriminatorValue); },
            "msdyn_quantity": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_quantity = n.getNumberValue(); },
            "msdyn_ResourceCategory": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_ResourceCategory = n.getObjectValue<Bookableresourcecategory>(createBookableresourcecategoryFromDiscriminatorValue); },
            "msdyn_ResourceOrganizationalUnitId": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_ResourceOrganizationalUnitId = n.getObjectValue<Msdyn_organizationalunit>(createMsdyn_organizationalunitFromDiscriminatorValue); },
            "msdyn_startdatetime": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_startdatetime = n.getDateValue(); },
            "msdyn_Task": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_Task = n.getObjectValue<Msdyn_projecttask>(createMsdyn_projecttaskFromDiscriminatorValue); },
            "msdyn_TransactionCategory": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_TransactionCategory = n.getObjectValue<Msdyn_transactioncategory>(createMsdyn_transactioncategoryFromDiscriminatorValue); },
            "msdyn_transactionclassification": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_transactionclassification = n.getNumberValue(); },
            "msdyn_transactiontypecode": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_transactiontypecode = n.getNumberValue(); },
            "msdyn_Unit": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_Unit = n.getObjectValue<Uom>(createUomFromDiscriminatorValue); },
            "msdyn_UnitSchedule": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_UnitSchedule = n.getObjectValue<Uomschedule>(createUomscheduleFromDiscriminatorValue); },
            "msdyn_vendortype": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).msdyn_vendortype = n.getNumberValue(); },
            "overriddencreatedon": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).overriddencreatedon = n.getDateValue(); },
            "ownerid": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).ownerid = n.getObjectValue<Principal>(createPrincipalFromDiscriminatorValue); },
            "owningbusinessunit": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).owningbusinessunit = n.getObjectValue<Businessunit>(createBusinessunitFromDiscriminatorValue); },
            "owningteam": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).owningteam = n.getObjectValue<Team>(createTeamFromDiscriminatorValue); },
            "owninguser": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).owninguser = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "statecode": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).statecode = n.getNumberValue(); },
            "statuscode": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).statuscode = n.getNumberValue(); },
            "timezoneruleversionnumber": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).timezoneruleversionnumber = n.getNumberValue(); },
            "transactioncurrencyid": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).transactioncurrencyid = n.getObjectValue<Transactioncurrency>(createTransactioncurrencyFromDiscriminatorValue); },
            "utcconversiontimezonecode": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).utcconversiontimezonecode = n.getNumberValue(); },
            "versionnumber": (o, n) => { (o as unknown as Msdyn_opportunitylinetransaction).versionnumber = n.getNumberValue(); },
        };
    };
    /**
    ...
    /**
     * Gets the msdyn_opportunitylinetransaction_Annotations property value. 
     * @returns a annotation
     */
    public get msdyn_opportunitylinetransaction_Annotations() {
        return this._msdyn_opportunitylinetransaction_Annotations;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_Annotations property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_Annotations property.
     */
    public set msdyn_opportunitylinetransaction_Annotations(value: Annotation[] | undefined) {
        this._msdyn_opportunitylinetransaction_Annotations = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_AsyncOperations property value. 
     * @returns a asyncoperation
     */
    public get msdyn_opportunitylinetransaction_AsyncOperations() {
        return this._msdyn_opportunitylinetransaction_AsyncOperations;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_AsyncOperations property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_AsyncOperations property.
     */
    public set msdyn_opportunitylinetransaction_AsyncOperations(value: Asyncoperation[] | undefined) {
        this._msdyn_opportunitylinetransaction_AsyncOperations = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_BulkDeleteFailures property value. 
     * @returns a bulkdeletefailure
     */
    public get msdyn_opportunitylinetransaction_BulkDeleteFailures() {
        return this._msdyn_opportunitylinetransaction_BulkDeleteFailures;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_BulkDeleteFailures property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_BulkDeleteFailures property.
     */
    public set msdyn_opportunitylinetransaction_BulkDeleteFailures(value: Bulkdeletefailure[] | undefined) {
        this._msdyn_opportunitylinetransaction_BulkDeleteFailures = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_DuplicateBaseRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_opportunitylinetransaction_DuplicateBaseRecord() {
        return this._msdyn_opportunitylinetransaction_DuplicateBaseRecord;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_DuplicateBaseRecord property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_DuplicateBaseRecord property.
     */
    public set msdyn_opportunitylinetransaction_DuplicateBaseRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_opportunitylinetransaction_DuplicateBaseRecord = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_DuplicateMatchingRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_opportunitylinetransaction_DuplicateMatchingRecord() {
        return this._msdyn_opportunitylinetransaction_DuplicateMatchingRecord;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_DuplicateMatchingRecord property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_DuplicateMatchingRecord property.
     */
    public set msdyn_opportunitylinetransaction_DuplicateMatchingRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_opportunitylinetransaction_DuplicateMatchingRecord = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_MailboxTrackingFolders property value. 
     * @returns a mailboxtrackingfolder
     */
    public get msdyn_opportunitylinetransaction_MailboxTrackingFolders() {
        return this._msdyn_opportunitylinetransaction_MailboxTrackingFolders;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_MailboxTrackingFolders property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_MailboxTrackingFolders property.
     */
    public set msdyn_opportunitylinetransaction_MailboxTrackingFolders(value: Mailboxtrackingfolder[] | undefined) {
        this._msdyn_opportunitylinetransaction_MailboxTrackingFolders = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @returns a principalobjectattributeaccess
     */
    public get msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses() {
        return this._msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses property.
     */
    public set msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses(value: Principalobjectattributeaccess[] | undefined) {
        this._msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_ProcessSession property value. 
     * @returns a processsession
     */
    public get msdyn_opportunitylinetransaction_ProcessSession() {
        return this._msdyn_opportunitylinetransaction_ProcessSession;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_ProcessSession property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_ProcessSession property.
     */
    public set msdyn_opportunitylinetransaction_ProcessSession(value: Processsession[] | undefined) {
        this._msdyn_opportunitylinetransaction_ProcessSession = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransaction_SyncErrors property value. 
     * @returns a syncerror
     */
    public get msdyn_opportunitylinetransaction_SyncErrors() {
        return this._msdyn_opportunitylinetransaction_SyncErrors;
    };
    /**
     * Sets the msdyn_opportunitylinetransaction_SyncErrors property value. 
     * @param value Value to set for the msdyn_opportunitylinetransaction_SyncErrors property.
     */
    public set msdyn_opportunitylinetransaction_SyncErrors(value: Syncerror[] | undefined) {
        this._msdyn_opportunitylinetransaction_SyncErrors = value;
    };
    /**
     * Gets the msdyn_opportunitylinetransactionid property value. 
     * @returns a string
     */
    public get msdyn_opportunitylinetransactionid() {
        return this._msdyn_opportunitylinetransactionid;
    };
    /**
     * Sets the msdyn_opportunitylinetransactionid property value. 
     * @param value Value to set for the msdyn_opportunitylinetransactionid property.
     */
    public set msdyn_opportunitylinetransactionid(value: string | undefined) {
        this._msdyn_opportunitylinetransactionid = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Annotation>("msdyn_opportunitylinetransaction_Annotations", this.msdyn_opportunitylinetransaction_Annotations);
        writer.writeCollectionOfObjectValues<Asyncoperation>("msdyn_opportunitylinetransaction_AsyncOperations", this.msdyn_opportunitylinetransaction_AsyncOperations);
        writer.writeCollectionOfObjectValues<Bulkdeletefailure>("msdyn_opportunitylinetransaction_BulkDeleteFailures", this.msdyn_opportunitylinetransaction_BulkDeleteFailures);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_opportunitylinetransaction_DuplicateBaseRecord", this.msdyn_opportunitylinetransaction_DuplicateBaseRecord);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_opportunitylinetransaction_DuplicateMatchingRecord", this.msdyn_opportunitylinetransaction_DuplicateMatchingRecord);
        writer.writeCollectionOfObjectValues<Mailboxtrackingfolder>("msdyn_opportunitylinetransaction_MailboxTrackingFolders", this.msdyn_opportunitylinetransaction_MailboxTrackingFolders);
        writer.writeCollectionOfObjectValues<Principalobjectattributeaccess>("msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses", this.msdyn_opportunitylinetransaction_PrincipalObjectAttributeAccesses);
        writer.writeCollectionOfObjectValues<Processsession>("msdyn_opportunitylinetransaction_ProcessSession", this.msdyn_opportunitylinetransaction_ProcessSession);
        writer.writeCollectionOfObjectValues<Syncerror>("msdyn_opportunitylinetransaction_SyncErrors", this.msdyn_opportunitylinetransaction_SyncErrors);
        writer.writeStringValue("msdyn_opportunitylinetransactionid", this.msdyn_opportunitylinetransactionid);
