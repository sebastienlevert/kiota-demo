...
export class Msdyn_orderlinetransaction extends Crmbaseentity implements Parsable {
    ...
    private __msdyn_quotelinetransactionid_value?: string | undefined;
    ...
    private _msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin?: Msdyn_orderlinetransaction[] | undefined;
    private _msdyn_orderlinetransaction_Annotations?: Annotation[] | undefined;
    private _msdyn_orderlinetransaction_AsyncOperations?: Asyncoperation[] | undefined;
    private _msdyn_orderlinetransaction_BulkDeleteFailures?: Bulkdeletefailure[] | undefined;
    private _msdyn_orderlinetransaction_DuplicateBaseRecord?: Duplicaterecord[] | undefined;
    private _msdyn_orderlinetransaction_DuplicateMatchingRecord?: Duplicaterecord[] | undefined;
    private _msdyn_orderlinetransaction_MailboxTrackingFolders?: Mailboxtrackingfolder[] | undefined;
    private _msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses?: Principalobjectattributeaccess[] | undefined;
    private _msdyn_orderlinetransaction_ProcessSession?: Processsession[] | undefined;
    private _msdyn_orderlinetransaction_SyncErrors?: Syncerror[] | undefined;
    private _msdyn_orderlinetransactionid?: string | undefined;
    private _msdyn_Origin?: Msdyn_orderlinetransaction | undefined;
    ...
    private _msdyn_QuoteLineTransactionId?: Msdyn_quotelinetransaction | undefined;
    ...
    /**
     * Gets the _msdyn_quotelinetransactionid_value property value. 
     * @returns a string
     */
    public get _msdyn_quotelinetransactionid_value() {
        return this.__msdyn_quotelinetransactionid_value;
    };
    /**
     * Sets the _msdyn_quotelinetransactionid_value property value. 
     * @param value Value to set for the _msdyn_quotelinetransactionid_value property.
     */
    public set _msdyn_quotelinetransactionid_value(value: string | undefined) {
        this.__msdyn_quotelinetransactionid_value = value;
    };
    /**
    ...
    /**
     * Instantiates a new msdyn_orderlinetransaction and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "_createdby_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._createdby_value = n.getStringValue(); },
            "_createdonbehalfby_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._createdonbehalfby_value = n.getStringValue(); },
            "_modifiedby_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._modifiedby_value = n.getStringValue(); },
            "_modifiedonbehalfby_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._modifiedonbehalfby_value = n.getStringValue(); },
            "_msdyn_accountcustomer_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_accountcustomer_value = n.getStringValue(); },
            "_msdyn_accountvendor_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_accountvendor_value = n.getStringValue(); },
            "_msdyn_bookableresource_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_bookableresource_value = n.getStringValue(); },
            "_msdyn_contactcustomer_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_contactcustomer_value = n.getStringValue(); },
            "_msdyn_contactvendor_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_contactvendor_value = n.getStringValue(); },
            "_msdyn_origin_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_origin_value = n.getStringValue(); },
            "_msdyn_pricelist_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_pricelist_value = n.getStringValue(); },
            "_msdyn_product_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_product_value = n.getStringValue(); },
            "_msdyn_project_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_project_value = n.getStringValue(); },
            "_msdyn_quotelinetransactionid_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_quotelinetransactionid_value = n.getStringValue(); },
            "_msdyn_resourcecategory_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_resourcecategory_value = n.getStringValue(); },
            "_msdyn_resourceorganizationalunitid_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_resourceorganizationalunitid_value = n.getStringValue(); },
            "_msdyn_salescontract_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_salescontract_value = n.getStringValue(); },
            "_msdyn_salescontractlineid_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_salescontractlineid_value = n.getStringValue(); },
            "_msdyn_task_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_task_value = n.getStringValue(); },
            "_msdyn_transactioncategory_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_transactioncategory_value = n.getStringValue(); },
            "_msdyn_unit_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_unit_value = n.getStringValue(); },
            "_msdyn_unitschedule_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._msdyn_unitschedule_value = n.getStringValue(); },
            "_ownerid_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._ownerid_value = n.getStringValue(); },
            "_owningbusinessunit_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._owningbusinessunit_value = n.getStringValue(); },
            "_owningteam_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._owningteam_value = n.getStringValue(); },
            "_owninguser_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._owninguser_value = n.getStringValue(); },
            "_transactioncurrencyid_value": (o, n) => { (o as unknown as Msdyn_orderlinetransaction)._transactioncurrencyid_value = n.getStringValue(); },
            "createdby": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).createdby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "createdon": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).createdon = n.getDateValue(); },
            "createdonbehalfby": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).createdonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "exchangerate": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).exchangerate = n.getNumberValue(); },
            "importsequencenumber": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).importsequencenumber = n.getNumberValue(); },
            "modifiedby": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).modifiedby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "modifiedon": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).modifiedon = n.getDateValue(); },
            "modifiedonbehalfby": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).modifiedonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "msdyn_AccountCustomer": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_AccountCustomer = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_accountingdate": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_accountingdate = n.getDateValue(); },
            "msdyn_AccountVendor": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_AccountVendor = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_amount": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_amount = n.getNumberValue(); },
            "msdyn_amount_after_tax": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_amount_after_tax = n.getNumberValue(); },
            "msdyn_amount_after_tax_base": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_amount_after_tax_base = n.getNumberValue(); },
            "msdyn_amount_base": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_amount_base = n.getNumberValue(); },
            "msdyn_amountmethod": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_amountmethod = n.getNumberValue(); },
            "msdyn_basisamount": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_basisamount = n.getNumberValue(); },
            "msdyn_basisamount_base": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_basisamount_base = n.getNumberValue(); },
            "msdyn_basisprice": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_basisprice = n.getNumberValue(); },
            "msdyn_basisprice_base": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_basisprice_base = n.getNumberValue(); },
            "msdyn_basisquantity": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_basisquantity = n.getNumberValue(); },
            "msdyn_billingtype": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_billingtype = n.getNumberValue(); },
            "msdyn_bookableresource": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_bookableresource = n.getObjectValue<Bookableresource>(createBookableresourceFromDiscriminatorValue); },
            "msdyn_ContactCustomer": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_ContactCustomer = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_ContactVendor": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_ContactVendor = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_customertype": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_customertype = n.getNumberValue(); },
            "msdyn_description": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_description = n.getStringValue(); },
            "msdyn_documentdate": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_documentdate = n.getDateValue(); },
            "msdyn_enddatetime": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_enddatetime = n.getDateValue(); },
            "msdyn_exchangeratedate": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_exchangeratedate = n.getDateValue(); },
            "msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin = n.getCollectionOfObjectValues<Msdyn_orderlinetransaction>(createMsdyn_orderlinetransactionFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_Annotations": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_Annotations = n.getCollectionOfObjectValues<Annotation>(createAnnotationFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_AsyncOperations": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_AsyncOperations = n.getCollectionOfObjectValues<Asyncoperation>(createAsyncoperationFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_BulkDeleteFailures": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_BulkDeleteFailures = n.getCollectionOfObjectValues<Bulkdeletefailure>(createBulkdeletefailureFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_DuplicateBaseRecord": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_DuplicateBaseRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_DuplicateMatchingRecord": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_DuplicateMatchingRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_MailboxTrackingFolders": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_MailboxTrackingFolders = n.getCollectionOfObjectValues<Mailboxtrackingfolder>(createMailboxtrackingfolderFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses = n.getCollectionOfObjectValues<Principalobjectattributeaccess>(createPrincipalobjectattributeaccessFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_ProcessSession": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_ProcessSession = n.getCollectionOfObjectValues<Processsession>(createProcesssessionFromDiscriminatorValue); },
            "msdyn_orderlinetransaction_SyncErrors": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransaction_SyncErrors = n.getCollectionOfObjectValues<Syncerror>(createSyncerrorFromDiscriminatorValue); },
            "msdyn_orderlinetransactionid": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_orderlinetransactionid = n.getStringValue(); },
            "msdyn_Origin": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_Origin = n.getObjectValue<Msdyn_orderlinetransaction>(createMsdyn_orderlinetransactionFromDiscriminatorValue); },
            "msdyn_percent": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_percent = n.getNumberValue(); },
            "msdyn_price": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_price = n.getNumberValue(); },
            "msdyn_price_base": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_price_base = n.getNumberValue(); },
            "msdyn_PriceList": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_PriceList = n.getObjectValue<Pricelevel>(createPricelevelFromDiscriminatorValue); },
            "msdyn_Product": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_Product = n.getObjectValue<Product>(createProductFromDiscriminatorValue); },
            "msdyn_Project": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_Project = n.getObjectValue<Msdyn_project>(createMsdyn_projectFromDiscriminatorValue); },
            "msdyn_quantity": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_quantity = n.getNumberValue(); },
            "msdyn_QuoteLineTransactionId": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_QuoteLineTransactionId = n.getObjectValue<Msdyn_quotelinetransaction>(createMsdyn_quotelinetransactionFromDiscriminatorValue); },
            "msdyn_ResourceCategory": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_ResourceCategory = n.getObjectValue<Bookableresourcecategory>(createBookableresourcecategoryFromDiscriminatorValue); },
            "msdyn_ResourceOrganizationalUnitId": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_ResourceOrganizationalUnitId = n.getObjectValue<Msdyn_organizationalunit>(createMsdyn_organizationalunitFromDiscriminatorValue); },
            "msdyn_SalesContract": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_SalesContract = n.getObjectValue<Salesorder>(createSalesorderFromDiscriminatorValue); },
            "msdyn_salescontractline": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_salescontractline = n.getStringValue(); },
            "msdyn_SalesContractLineId": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_SalesContractLineId = n.getObjectValue<Salesorderdetail>(createSalesorderdetailFromDiscriminatorValue); },
            "msdyn_startdatetime": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_startdatetime = n.getDateValue(); },
            "msdyn_Task": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_Task = n.getObjectValue<Msdyn_projecttask>(createMsdyn_projecttaskFromDiscriminatorValue); },
            "msdyn_tax": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_tax = n.getNumberValue(); },
            "msdyn_tax_base": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_tax_base = n.getNumberValue(); },
            "msdyn_TransactionCategory": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_TransactionCategory = n.getObjectValue<Msdyn_transactioncategory>(createMsdyn_transactioncategoryFromDiscriminatorValue); },
            "msdyn_transactionclassification": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_transactionclassification = n.getNumberValue(); },
            "msdyn_transactiontypecode": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_transactiontypecode = n.getNumberValue(); },
            "msdyn_Unit": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_Unit = n.getObjectValue<Uom>(createUomFromDiscriminatorValue); },
            "msdyn_UnitSchedule": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_UnitSchedule = n.getObjectValue<Uomschedule>(createUomscheduleFromDiscriminatorValue); },
            "msdyn_vendortype": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).msdyn_vendortype = n.getNumberValue(); },
            "overriddencreatedon": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).overriddencreatedon = n.getDateValue(); },
            "ownerid": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).ownerid = n.getObjectValue<Principal>(createPrincipalFromDiscriminatorValue); },
            "owningbusinessunit": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).owningbusinessunit = n.getObjectValue<Businessunit>(createBusinessunitFromDiscriminatorValue); },
            "owningteam": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).owningteam = n.getObjectValue<Team>(createTeamFromDiscriminatorValue); },
            "owninguser": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).owninguser = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "statecode": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).statecode = n.getNumberValue(); },
            "statuscode": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).statuscode = n.getNumberValue(); },
            "timezoneruleversionnumber": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).timezoneruleversionnumber = n.getNumberValue(); },
            "transactioncurrencyid": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).transactioncurrencyid = n.getObjectValue<Transactioncurrency>(createTransactioncurrencyFromDiscriminatorValue); },
            "utcconversiontimezonecode": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).utcconversiontimezonecode = n.getNumberValue(); },
            "versionnumber": (o, n) => { (o as unknown as Msdyn_orderlinetransaction).versionnumber = n.getNumberValue(); },
        };
    };
    /**
    ...
    /**
     * Gets the msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin property value. 
     * @returns a msdyn_orderlinetransaction
     */
    public get msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin() {
        return this._msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin;
    };
    /**
     * Sets the msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin property value. 
     * @param value Value to set for the msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin property.
     */
    public set msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin(value: Msdyn_orderlinetransaction[] | undefined) {
        this._msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_Annotations property value. 
     * @returns a annotation
     */
    public get msdyn_orderlinetransaction_Annotations() {
        return this._msdyn_orderlinetransaction_Annotations;
    };
    /**
     * Sets the msdyn_orderlinetransaction_Annotations property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_Annotations property.
     */
    public set msdyn_orderlinetransaction_Annotations(value: Annotation[] | undefined) {
        this._msdyn_orderlinetransaction_Annotations = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_AsyncOperations property value. 
     * @returns a asyncoperation
     */
    public get msdyn_orderlinetransaction_AsyncOperations() {
        return this._msdyn_orderlinetransaction_AsyncOperations;
    };
    /**
     * Sets the msdyn_orderlinetransaction_AsyncOperations property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_AsyncOperations property.
     */
    public set msdyn_orderlinetransaction_AsyncOperations(value: Asyncoperation[] | undefined) {
        this._msdyn_orderlinetransaction_AsyncOperations = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_BulkDeleteFailures property value. 
     * @returns a bulkdeletefailure
     */
    public get msdyn_orderlinetransaction_BulkDeleteFailures() {
        return this._msdyn_orderlinetransaction_BulkDeleteFailures;
    };
    /**
     * Sets the msdyn_orderlinetransaction_BulkDeleteFailures property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_BulkDeleteFailures property.
     */
    public set msdyn_orderlinetransaction_BulkDeleteFailures(value: Bulkdeletefailure[] | undefined) {
        this._msdyn_orderlinetransaction_BulkDeleteFailures = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_DuplicateBaseRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_orderlinetransaction_DuplicateBaseRecord() {
        return this._msdyn_orderlinetransaction_DuplicateBaseRecord;
    };
    /**
     * Sets the msdyn_orderlinetransaction_DuplicateBaseRecord property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_DuplicateBaseRecord property.
     */
    public set msdyn_orderlinetransaction_DuplicateBaseRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_orderlinetransaction_DuplicateBaseRecord = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_DuplicateMatchingRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_orderlinetransaction_DuplicateMatchingRecord() {
        return this._msdyn_orderlinetransaction_DuplicateMatchingRecord;
    };
    /**
     * Sets the msdyn_orderlinetransaction_DuplicateMatchingRecord property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_DuplicateMatchingRecord property.
     */
    public set msdyn_orderlinetransaction_DuplicateMatchingRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_orderlinetransaction_DuplicateMatchingRecord = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_MailboxTrackingFolders property value. 
     * @returns a mailboxtrackingfolder
     */
    public get msdyn_orderlinetransaction_MailboxTrackingFolders() {
        return this._msdyn_orderlinetransaction_MailboxTrackingFolders;
    };
    /**
     * Sets the msdyn_orderlinetransaction_MailboxTrackingFolders property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_MailboxTrackingFolders property.
     */
    public set msdyn_orderlinetransaction_MailboxTrackingFolders(value: Mailboxtrackingfolder[] | undefined) {
        this._msdyn_orderlinetransaction_MailboxTrackingFolders = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @returns a principalobjectattributeaccess
     */
    public get msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses() {
        return this._msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses;
    };
    /**
     * Sets the msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses property.
     */
    public set msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses(value: Principalobjectattributeaccess[] | undefined) {
        this._msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_ProcessSession property value. 
     * @returns a processsession
     */
    public get msdyn_orderlinetransaction_ProcessSession() {
        return this._msdyn_orderlinetransaction_ProcessSession;
    };
    /**
     * Sets the msdyn_orderlinetransaction_ProcessSession property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_ProcessSession property.
     */
    public set msdyn_orderlinetransaction_ProcessSession(value: Processsession[] | undefined) {
        this._msdyn_orderlinetransaction_ProcessSession = value;
    };
    /**
     * Gets the msdyn_orderlinetransaction_SyncErrors property value. 
     * @returns a syncerror
     */
    public get msdyn_orderlinetransaction_SyncErrors() {
        return this._msdyn_orderlinetransaction_SyncErrors;
    };
    /**
     * Sets the msdyn_orderlinetransaction_SyncErrors property value. 
     * @param value Value to set for the msdyn_orderlinetransaction_SyncErrors property.
     */
    public set msdyn_orderlinetransaction_SyncErrors(value: Syncerror[] | undefined) {
        this._msdyn_orderlinetransaction_SyncErrors = value;
    };
    /**
     * Gets the msdyn_orderlinetransactionid property value. 
     * @returns a string
     */
    public get msdyn_orderlinetransactionid() {
        return this._msdyn_orderlinetransactionid;
    };
    /**
     * Sets the msdyn_orderlinetransactionid property value. 
     * @param value Value to set for the msdyn_orderlinetransactionid property.
     */
    public set msdyn_orderlinetransactionid(value: string | undefined) {
        this._msdyn_orderlinetransactionid = value;
    };
    /**
     ...
     */
    public set msdyn_Origin(value: Msdyn_orderlinetransaction | undefined) {
     ...
     */
    public set msdyn_QuoteLineTransactionId(value: Msdyn_quotelinetransaction | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeStringValue("_msdyn_quotelinetransactionid_value", this._msdyn_quotelinetransactionid_value);
        ...
        writer.writeCollectionOfObjectValues<Msdyn_orderlinetransaction>("msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin", this.msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin);
        writer.writeCollectionOfObjectValues<Annotation>("msdyn_orderlinetransaction_Annotations", this.msdyn_orderlinetransaction_Annotations);
        writer.writeCollectionOfObjectValues<Asyncoperation>("msdyn_orderlinetransaction_AsyncOperations", this.msdyn_orderlinetransaction_AsyncOperations);
        writer.writeCollectionOfObjectValues<Bulkdeletefailure>("msdyn_orderlinetransaction_BulkDeleteFailures", this.msdyn_orderlinetransaction_BulkDeleteFailures);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_orderlinetransaction_DuplicateBaseRecord", this.msdyn_orderlinetransaction_DuplicateBaseRecord);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_orderlinetransaction_DuplicateMatchingRecord", this.msdyn_orderlinetransaction_DuplicateMatchingRecord);
        writer.writeCollectionOfObjectValues<Mailboxtrackingfolder>("msdyn_orderlinetransaction_MailboxTrackingFolders", this.msdyn_orderlinetransaction_MailboxTrackingFolders);
        writer.writeCollectionOfObjectValues<Principalobjectattributeaccess>("msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses", this.msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses);
        writer.writeCollectionOfObjectValues<Processsession>("msdyn_orderlinetransaction_ProcessSession", this.msdyn_orderlinetransaction_ProcessSession);
        writer.writeCollectionOfObjectValues<Syncerror>("msdyn_orderlinetransaction_SyncErrors", this.msdyn_orderlinetransaction_SyncErrors);
        writer.writeStringValue("msdyn_orderlinetransactionid", this.msdyn_orderlinetransactionid);
        writer.writeObjectValue<Msdyn_orderlinetransaction>("msdyn_Origin", this.msdyn_Origin);
        ...
        writer.writeObjectValue<Msdyn_quotelinetransaction>("msdyn_QuoteLineTransactionId", this.msdyn_QuoteLineTransactionId);
