...
import {Account, Annotation, Asyncoperation, Bookableresource, Bookableresourcecategory, Bulkdeletefailure, Businessunit, Contact, Crmbaseentity, Duplicaterecord, Mailboxtrackingfolder, Msdyn_orderlinetransaction, Msdyn_organizationalunit, Msdyn_project, Msdyn_projecttask, Msdyn_quotelineanalyticsbreakdown, Msdyn_transactioncategory, Pricelevel, Principal, Principalobjectattributeaccess, Processsession, Product, Quote, Quotedetail, Syncerror, Systemuser, Team, Transactioncurrency, Uom, Uomschedule} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Msdyn_quotelinetransaction extends Crmbaseentity implements Parsable {
    ...
    private __msdyn_origin_value?: string | undefined;
    ...
    private __msdyn_quoteid_value?: string | undefined;
    ...
    private _msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail?: Msdyn_quotelineanalyticsbreakdown[] | undefined;
    private _msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin?: Msdyn_quotelinetransaction[] | undefined;
    private _msdyn_Origin?: Msdyn_quotelinetransaction | undefined;
    ...
    private _msdyn_QuoteId?: Quote | undefined;
    private _msdyn_quoteline?: string | undefined;
    private _msdyn_quotelineid?: Quotedetail | undefined;
    private _msdyn_quotelinetransaction_Annotations?: Annotation[] | undefined;
    private _msdyn_quotelinetransaction_AsyncOperations?: Asyncoperation[] | undefined;
    private _msdyn_quotelinetransaction_BulkDeleteFailures?: Bulkdeletefailure[] | undefined;
    private _msdyn_quotelinetransaction_DuplicateBaseRecord?: Duplicaterecord[] | undefined;
    private _msdyn_quotelinetransaction_DuplicateMatchingRecord?: Duplicaterecord[] | undefined;
    private _msdyn_quotelinetransaction_MailboxTrackingFolders?: Mailboxtrackingfolder[] | undefined;
    private _msdyn_quotelinetransaction_msdyn_orderlinetransaction?: Msdyn_orderlinetransaction[] | undefined;
    private _msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses?: Principalobjectattributeaccess[] | undefined;
    private _msdyn_quotelinetransaction_ProcessSession?: Processsession[] | undefined;
    private _msdyn_quotelinetransaction_SyncErrors?: Syncerror[] | undefined;
    private _msdyn_quotelinetransactionid?: string | undefined;
    ...
    /**
     * Gets the _msdyn_origin_value property value. 
     * @returns a string
     */
    public get _msdyn_origin_value() {
        return this.__msdyn_origin_value;
    };
    /**
     * Sets the _msdyn_origin_value property value. 
     * @param value Value to set for the _msdyn_origin_value property.
     */
    public set _msdyn_origin_value(value: string | undefined) {
        this.__msdyn_origin_value = value;
    };
    /**
    ...
    /**
     * Gets the _msdyn_quoteid_value property value. 
     * @returns a string
     */
    public get _msdyn_quoteid_value() {
        return this.__msdyn_quoteid_value;
    };
    /**
     * Sets the _msdyn_quoteid_value property value. 
     * @param value Value to set for the _msdyn_quoteid_value property.
     */
    public set _msdyn_quoteid_value(value: string | undefined) {
        this.__msdyn_quoteid_value = value;
    };
    /**
    ...
    /**
     * Instantiates a new msdyn_quotelinetransaction and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "_createdby_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._createdby_value = n.getStringValue(); },
            "_createdonbehalfby_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._createdonbehalfby_value = n.getStringValue(); },
            "_modifiedby_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._modifiedby_value = n.getStringValue(); },
            "_modifiedonbehalfby_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._modifiedonbehalfby_value = n.getStringValue(); },
            "_msdyn_accountcustomer_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_accountcustomer_value = n.getStringValue(); },
            "_msdyn_accountvendor_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_accountvendor_value = n.getStringValue(); },
            "_msdyn_bookableresource_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_bookableresource_value = n.getStringValue(); },
            "_msdyn_contactcustomer_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_contactcustomer_value = n.getStringValue(); },
            "_msdyn_contactvendor_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_contactvendor_value = n.getStringValue(); },
            "_msdyn_origin_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_origin_value = n.getStringValue(); },
            "_msdyn_pricelist_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_pricelist_value = n.getStringValue(); },
            "_msdyn_product_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_product_value = n.getStringValue(); },
            "_msdyn_project_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_project_value = n.getStringValue(); },
            "_msdyn_quoteid_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_quoteid_value = n.getStringValue(); },
            "_msdyn_quotelineid_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_quotelineid_value = n.getStringValue(); },
            "_msdyn_resourcecategory_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_resourcecategory_value = n.getStringValue(); },
            "_msdyn_resourceorganizationalunitid_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_resourceorganizationalunitid_value = n.getStringValue(); },
            "_msdyn_task_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_task_value = n.getStringValue(); },
            "_msdyn_transactioncategory_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_transactioncategory_value = n.getStringValue(); },
            "_msdyn_unit_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_unit_value = n.getStringValue(); },
            "_msdyn_unitschedule_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._msdyn_unitschedule_value = n.getStringValue(); },
            "_ownerid_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._ownerid_value = n.getStringValue(); },
            "_owningbusinessunit_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._owningbusinessunit_value = n.getStringValue(); },
            "_owningteam_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._owningteam_value = n.getStringValue(); },
            "_owninguser_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._owninguser_value = n.getStringValue(); },
            "_transactioncurrencyid_value": (o, n) => { (o as unknown as Msdyn_quotelinetransaction)._transactioncurrencyid_value = n.getStringValue(); },
            "createdby": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).createdby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "createdon": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).createdon = n.getDateValue(); },
            "createdonbehalfby": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).createdonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "exchangerate": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).exchangerate = n.getNumberValue(); },
            "importsequencenumber": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).importsequencenumber = n.getNumberValue(); },
            "modifiedby": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).modifiedby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "modifiedon": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).modifiedon = n.getDateValue(); },
            "modifiedonbehalfby": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).modifiedonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "msdyn_AccountCustomer": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_AccountCustomer = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_accountingdate": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_accountingdate = n.getDateValue(); },
            "msdyn_AccountVendor": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_AccountVendor = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_amount": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_amount = n.getNumberValue(); },
            "msdyn_amount_after_tax": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_amount_after_tax = n.getNumberValue(); },
            "msdyn_amount_after_tax_base": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_amount_after_tax_base = n.getNumberValue(); },
            "msdyn_amount_base": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_amount_base = n.getNumberValue(); },
            "msdyn_amountmethod": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_amountmethod = n.getNumberValue(); },
            "msdyn_basisamount": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_basisamount = n.getNumberValue(); },
            "msdyn_basisamount_base": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_basisamount_base = n.getNumberValue(); },
            "msdyn_basisprice": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_basisprice = n.getNumberValue(); },
            "msdyn_basisprice_base": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_basisprice_base = n.getNumberValue(); },
            "msdyn_basisquantity": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_basisquantity = n.getNumberValue(); },
            "msdyn_billingtype": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_billingtype = n.getNumberValue(); },
            "msdyn_bookableresource": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_bookableresource = n.getObjectValue<Bookableresource>(createBookableresourceFromDiscriminatorValue); },
            "msdyn_ContactCustomer": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_ContactCustomer = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_ContactVendor": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_ContactVendor = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_customertype": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_customertype = n.getNumberValue(); },
            "msdyn_description": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_description = n.getStringValue(); },
            "msdyn_documentdate": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_documentdate = n.getDateValue(); },
            "msdyn_enddatetime": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_enddatetime = n.getDateValue(); },
            "msdyn_exchangeratedate": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_exchangeratedate = n.getDateValue(); },
            "msdyn_isdataimport": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_isdataimport = n.getBooleanValue(); },
            "msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail = n.getCollectionOfObjectValues<Msdyn_quotelineanalyticsbreakdown>(createMsdyn_quotelineanalyticsbreakdownFromDiscriminatorValue); },
            "msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin = n.getCollectionOfObjectValues<Msdyn_quotelinetransaction>(createMsdyn_quotelinetransactionFromDiscriminatorValue); },
            "msdyn_Origin": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_Origin = n.getObjectValue<Msdyn_quotelinetransaction>(createMsdyn_quotelinetransactionFromDiscriminatorValue); },
            "msdyn_percent": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_percent = n.getNumberValue(); },
            "msdyn_price": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_price = n.getNumberValue(); },
            "msdyn_price_base": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_price_base = n.getNumberValue(); },
            "msdyn_PriceList": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_PriceList = n.getObjectValue<Pricelevel>(createPricelevelFromDiscriminatorValue); },
            "msdyn_Product": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_Product = n.getObjectValue<Product>(createProductFromDiscriminatorValue); },
            "msdyn_Project": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_Project = n.getObjectValue<Msdyn_project>(createMsdyn_projectFromDiscriminatorValue); },
            "msdyn_quantity": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quantity = n.getNumberValue(); },
            "msdyn_QuoteId": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_QuoteId = n.getObjectValue<Quote>(createQuoteFromDiscriminatorValue); },
            "msdyn_quoteline": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quoteline = n.getStringValue(); },
            "msdyn_quotelineid": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelineid = n.getObjectValue<Quotedetail>(createQuotedetailFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_Annotations": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_Annotations = n.getCollectionOfObjectValues<Annotation>(createAnnotationFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_AsyncOperations": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_AsyncOperations = n.getCollectionOfObjectValues<Asyncoperation>(createAsyncoperationFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_BulkDeleteFailures": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_BulkDeleteFailures = n.getCollectionOfObjectValues<Bulkdeletefailure>(createBulkdeletefailureFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_DuplicateBaseRecord": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_DuplicateBaseRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_DuplicateMatchingRecord": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_DuplicateMatchingRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_MailboxTrackingFolders": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_MailboxTrackingFolders = n.getCollectionOfObjectValues<Mailboxtrackingfolder>(createMailboxtrackingfolderFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_msdyn_orderlinetransaction": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_msdyn_orderlinetransaction = n.getCollectionOfObjectValues<Msdyn_orderlinetransaction>(createMsdyn_orderlinetransactionFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses = n.getCollectionOfObjectValues<Principalobjectattributeaccess>(createPrincipalobjectattributeaccessFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_ProcessSession": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_ProcessSession = n.getCollectionOfObjectValues<Processsession>(createProcesssessionFromDiscriminatorValue); },
            "msdyn_quotelinetransaction_SyncErrors": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransaction_SyncErrors = n.getCollectionOfObjectValues<Syncerror>(createSyncerrorFromDiscriminatorValue); },
            "msdyn_quotelinetransactionid": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_quotelinetransactionid = n.getStringValue(); },
            "msdyn_ResourceCategory": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_ResourceCategory = n.getObjectValue<Bookableresourcecategory>(createBookableresourcecategoryFromDiscriminatorValue); },
            "msdyn_ResourceOrganizationalUnitId": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_ResourceOrganizationalUnitId = n.getObjectValue<Msdyn_organizationalunit>(createMsdyn_organizationalunitFromDiscriminatorValue); },
            "msdyn_startdatetime": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_startdatetime = n.getDateValue(); },
            "msdyn_Task": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_Task = n.getObjectValue<Msdyn_projecttask>(createMsdyn_projecttaskFromDiscriminatorValue); },
            "msdyn_tax": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_tax = n.getNumberValue(); },
            "msdyn_tax_base": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_tax_base = n.getNumberValue(); },
            "msdyn_TransactionCategory": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_TransactionCategory = n.getObjectValue<Msdyn_transactioncategory>(createMsdyn_transactioncategoryFromDiscriminatorValue); },
            "msdyn_transactionclassification": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_transactionclassification = n.getNumberValue(); },
            "msdyn_transactiontypecode": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_transactiontypecode = n.getNumberValue(); },
            "msdyn_Unit": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_Unit = n.getObjectValue<Uom>(createUomFromDiscriminatorValue); },
            "msdyn_UnitSchedule": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_UnitSchedule = n.getObjectValue<Uomschedule>(createUomscheduleFromDiscriminatorValue); },
            "msdyn_vendortype": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).msdyn_vendortype = n.getNumberValue(); },
            "overriddencreatedon": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).overriddencreatedon = n.getDateValue(); },
            "ownerid": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).ownerid = n.getObjectValue<Principal>(createPrincipalFromDiscriminatorValue); },
            "owningbusinessunit": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).owningbusinessunit = n.getObjectValue<Businessunit>(createBusinessunitFromDiscriminatorValue); },
            "owningteam": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).owningteam = n.getObjectValue<Team>(createTeamFromDiscriminatorValue); },
            "owninguser": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).owninguser = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "statecode": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).statecode = n.getNumberValue(); },
            "statuscode": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).statuscode = n.getNumberValue(); },
            "timezoneruleversionnumber": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).timezoneruleversionnumber = n.getNumberValue(); },
            "transactioncurrencyid": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).transactioncurrencyid = n.getObjectValue<Transactioncurrency>(createTransactioncurrencyFromDiscriminatorValue); },
            "utcconversiontimezonecode": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).utcconversiontimezonecode = n.getNumberValue(); },
            "versionnumber": (o, n) => { (o as unknown as Msdyn_quotelinetransaction).versionnumber = n.getNumberValue(); },
        };
    };
    /**
    ...
    /**
     * Gets the msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail property value. 
     * @returns a msdyn_quotelineanalyticsbreakdown
     */
    public get msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail() {
        return this._msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail;
    };
    /**
     * Sets the msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail property value. 
     * @param value Value to set for the msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail property.
     */
    public set msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail(value: Msdyn_quotelineanalyticsbreakdown[] | undefined) {
        this._msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail = value;
    };
    /**
     * Gets the msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin property value. 
     * @returns a msdyn_quotelinetransaction
     */
    public get msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin() {
        return this._msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin;
    };
    /**
     * Sets the msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin property value. 
     * @param value Value to set for the msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin property.
     */
    public set msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin(value: Msdyn_quotelinetransaction[] | undefined) {
        this._msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin = value;
    };
    /**
     * Gets the msdyn_Origin property value. 
     * @returns a msdyn_quotelinetransaction
     */
    public get msdyn_Origin() {
        return this._msdyn_Origin;
    };
    /**
     * Sets the msdyn_Origin property value. 
     * @param value Value to set for the msdyn_Origin property.
     */
    public set msdyn_Origin(value: Msdyn_quotelinetransaction | undefined) {
        this._msdyn_Origin = value;
    };
    /**
    ...
    /**
     * Gets the msdyn_QuoteId property value. 
     * @returns a quote
     */
    public get msdyn_QuoteId() {
        return this._msdyn_QuoteId;
    };
    /**
     * Sets the msdyn_QuoteId property value. 
     * @param value Value to set for the msdyn_QuoteId property.
     */
    public set msdyn_QuoteId(value: Quote | undefined) {
        this._msdyn_QuoteId = value;
    };
    /**
    ...
    /**
     * Gets the msdyn_quotelinetransaction_Annotations property value. 
     * @returns a annotation
     */
    public get msdyn_quotelinetransaction_Annotations() {
        return this._msdyn_quotelinetransaction_Annotations;
    };
    /**
     * Sets the msdyn_quotelinetransaction_Annotations property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_Annotations property.
     */
    public set msdyn_quotelinetransaction_Annotations(value: Annotation[] | undefined) {
        this._msdyn_quotelinetransaction_Annotations = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_AsyncOperations property value. 
     * @returns a asyncoperation
     */
    public get msdyn_quotelinetransaction_AsyncOperations() {
        return this._msdyn_quotelinetransaction_AsyncOperations;
    };
    /**
     * Sets the msdyn_quotelinetransaction_AsyncOperations property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_AsyncOperations property.
     */
    public set msdyn_quotelinetransaction_AsyncOperations(value: Asyncoperation[] | undefined) {
        this._msdyn_quotelinetransaction_AsyncOperations = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_BulkDeleteFailures property value. 
     * @returns a bulkdeletefailure
     */
    public get msdyn_quotelinetransaction_BulkDeleteFailures() {
        return this._msdyn_quotelinetransaction_BulkDeleteFailures;
    };
    /**
     * Sets the msdyn_quotelinetransaction_BulkDeleteFailures property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_BulkDeleteFailures property.
     */
    public set msdyn_quotelinetransaction_BulkDeleteFailures(value: Bulkdeletefailure[] | undefined) {
        this._msdyn_quotelinetransaction_BulkDeleteFailures = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_DuplicateBaseRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_quotelinetransaction_DuplicateBaseRecord() {
        return this._msdyn_quotelinetransaction_DuplicateBaseRecord;
    };
    /**
     * Sets the msdyn_quotelinetransaction_DuplicateBaseRecord property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_DuplicateBaseRecord property.
     */
    public set msdyn_quotelinetransaction_DuplicateBaseRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_quotelinetransaction_DuplicateBaseRecord = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_DuplicateMatchingRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_quotelinetransaction_DuplicateMatchingRecord() {
        return this._msdyn_quotelinetransaction_DuplicateMatchingRecord;
    };
    /**
     * Sets the msdyn_quotelinetransaction_DuplicateMatchingRecord property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_DuplicateMatchingRecord property.
     */
    public set msdyn_quotelinetransaction_DuplicateMatchingRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_quotelinetransaction_DuplicateMatchingRecord = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_MailboxTrackingFolders property value. 
     * @returns a mailboxtrackingfolder
     */
    public get msdyn_quotelinetransaction_MailboxTrackingFolders() {
        return this._msdyn_quotelinetransaction_MailboxTrackingFolders;
    };
    /**
     * Sets the msdyn_quotelinetransaction_MailboxTrackingFolders property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_MailboxTrackingFolders property.
     */
    public set msdyn_quotelinetransaction_MailboxTrackingFolders(value: Mailboxtrackingfolder[] | undefined) {
        this._msdyn_quotelinetransaction_MailboxTrackingFolders = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_msdyn_orderlinetransaction property value. 
     * @returns a msdyn_orderlinetransaction
     */
    public get msdyn_quotelinetransaction_msdyn_orderlinetransaction() {
        return this._msdyn_quotelinetransaction_msdyn_orderlinetransaction;
    };
    /**
     * Sets the msdyn_quotelinetransaction_msdyn_orderlinetransaction property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_msdyn_orderlinetransaction property.
     */
    public set msdyn_quotelinetransaction_msdyn_orderlinetransaction(value: Msdyn_orderlinetransaction[] | undefined) {
        this._msdyn_quotelinetransaction_msdyn_orderlinetransaction = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @returns a principalobjectattributeaccess
     */
    public get msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses() {
        return this._msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses;
    };
    /**
     * Sets the msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses property.
     */
    public set msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses(value: Principalobjectattributeaccess[] | undefined) {
        this._msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_ProcessSession property value. 
     * @returns a processsession
     */
    public get msdyn_quotelinetransaction_ProcessSession() {
        return this._msdyn_quotelinetransaction_ProcessSession;
    };
    /**
     * Sets the msdyn_quotelinetransaction_ProcessSession property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_ProcessSession property.
     */
    public set msdyn_quotelinetransaction_ProcessSession(value: Processsession[] | undefined) {
        this._msdyn_quotelinetransaction_ProcessSession = value;
    };
    /**
     * Gets the msdyn_quotelinetransaction_SyncErrors property value. 
     * @returns a syncerror
     */
    public get msdyn_quotelinetransaction_SyncErrors() {
        return this._msdyn_quotelinetransaction_SyncErrors;
    };
    /**
     * Sets the msdyn_quotelinetransaction_SyncErrors property value. 
     * @param value Value to set for the msdyn_quotelinetransaction_SyncErrors property.
     */
    public set msdyn_quotelinetransaction_SyncErrors(value: Syncerror[] | undefined) {
        this._msdyn_quotelinetransaction_SyncErrors = value;
    };
    /**
     * Gets the msdyn_quotelinetransactionid property value. 
     * @returns a string
     */
    public get msdyn_quotelinetransactionid() {
        return this._msdyn_quotelinetransactionid;
    };
    /**
     * Sets the msdyn_quotelinetransactionid property value. 
     * @param value Value to set for the msdyn_quotelinetransactionid property.
     */
    public set msdyn_quotelinetransactionid(value: string | undefined) {
        this._msdyn_quotelinetransactionid = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeStringValue("_msdyn_origin_value", this._msdyn_origin_value);
        ...
        writer.writeStringValue("_msdyn_quoteid_value", this._msdyn_quoteid_value);
        ...
        writer.writeCollectionOfObjectValues<Msdyn_quotelineanalyticsbreakdown>("msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail", this.msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail);
        writer.writeCollectionOfObjectValues<Msdyn_quotelinetransaction>("msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin", this.msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin);
        writer.writeObjectValue<Msdyn_quotelinetransaction>("msdyn_Origin", this.msdyn_Origin);
        ...
        writer.writeObjectValue<Quote>("msdyn_QuoteId", this.msdyn_QuoteId);
        ...
        writer.writeCollectionOfObjectValues<Annotation>("msdyn_quotelinetransaction_Annotations", this.msdyn_quotelinetransaction_Annotations);
        writer.writeCollectionOfObjectValues<Asyncoperation>("msdyn_quotelinetransaction_AsyncOperations", this.msdyn_quotelinetransaction_AsyncOperations);
        writer.writeCollectionOfObjectValues<Bulkdeletefailure>("msdyn_quotelinetransaction_BulkDeleteFailures", this.msdyn_quotelinetransaction_BulkDeleteFailures);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_quotelinetransaction_DuplicateBaseRecord", this.msdyn_quotelinetransaction_DuplicateBaseRecord);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_quotelinetransaction_DuplicateMatchingRecord", this.msdyn_quotelinetransaction_DuplicateMatchingRecord);
        writer.writeCollectionOfObjectValues<Mailboxtrackingfolder>("msdyn_quotelinetransaction_MailboxTrackingFolders", this.msdyn_quotelinetransaction_MailboxTrackingFolders);
        writer.writeCollectionOfObjectValues<Msdyn_orderlinetransaction>("msdyn_quotelinetransaction_msdyn_orderlinetransaction", this.msdyn_quotelinetransaction_msdyn_orderlinetransaction);
        writer.writeCollectionOfObjectValues<Principalobjectattributeaccess>("msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses", this.msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses);
        writer.writeCollectionOfObjectValues<Processsession>("msdyn_quotelinetransaction_ProcessSession", this.msdyn_quotelinetransaction_ProcessSession);
        writer.writeCollectionOfObjectValues<Syncerror>("msdyn_quotelinetransaction_SyncErrors", this.msdyn_quotelinetransaction_SyncErrors);
        writer.writeStringValue("msdyn_quotelinetransactionid", this.msdyn_quotelinetransactionid);
