...
import {Account, Annotation, Asyncoperation, Bookableresource, Bookableresourcecategory, Bulkdeletefailure, Businessunit, Contact, Crmbaseentity, Duplicaterecord, Mailboxtrackingfolder, Msdyn_estimate, Msdyn_fact, Msdyn_organizationalunit, Msdyn_project, Msdyn_projecttask, Msdyn_transactioncategory, Pricelevel, Principal, Principalobjectattributeaccess, Processsession, Product, Syncerror, Systemuser, Team, Transactioncurrency, Uom, Uomschedule} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Msdyn_estimateline extends Crmbaseentity implements Parsable {
    ...
    private _msdyn_estimateline_Annotations?: Annotation[] | undefined;
    private _msdyn_estimateline_AsyncOperations?: Asyncoperation[] | undefined;
    private _msdyn_estimateline_BulkDeleteFailures?: Bulkdeletefailure[] | undefined;
    private _msdyn_estimateline_DuplicateBaseRecord?: Duplicaterecord[] | undefined;
    private _msdyn_estimateline_DuplicateMatchingRecord?: Duplicaterecord[] | undefined;
    private _msdyn_estimateline_MailboxTrackingFolders?: Mailboxtrackingfolder[] | undefined;
    private _msdyn_estimateline_PrincipalObjectAttributeAccesses?: Principalobjectattributeaccess[] | undefined;
    private _msdyn_estimateline_ProcessSession?: Processsession[] | undefined;
    private _msdyn_estimateline_SyncErrors?: Syncerror[] | undefined;
    private _msdyn_estimatelineid?: string | undefined;
    private _msdyn_estimateperdaylines?: string | undefined;
    private _msdyn_exchangeratedate?: Date | undefined;
    private _msdyn_msdyn_estimateline_msdyn_estimateline_Origin?: Msdyn_estimateline[] | undefined;
    private _msdyn_msdyn_estimateline_msdyn_fact_estimatelineid?: Msdyn_fact[] | undefined;
    private _msdyn_numberofresources?: number | undefined;
    private _msdyn_Origin?: Msdyn_estimateline | undefined;
    ...
    /**
     * Instantiates a new msdyn_estimateline and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "_createdby_value": (o, n) => { (o as unknown as Msdyn_estimateline)._createdby_value = n.getStringValue(); },
            "_createdonbehalfby_value": (o, n) => { (o as unknown as Msdyn_estimateline)._createdonbehalfby_value = n.getStringValue(); },
            "_modifiedby_value": (o, n) => { (o as unknown as Msdyn_estimateline)._modifiedby_value = n.getStringValue(); },
            "_modifiedonbehalfby_value": (o, n) => { (o as unknown as Msdyn_estimateline)._modifiedonbehalfby_value = n.getStringValue(); },
            "_msdyn_accountcustomer_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_accountcustomer_value = n.getStringValue(); },
            "_msdyn_accountvendor_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_accountvendor_value = n.getStringValue(); },
            "_msdyn_bookableresource_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_bookableresource_value = n.getStringValue(); },
            "_msdyn_contactcustomer_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_contactcustomer_value = n.getStringValue(); },
            "_msdyn_contactvendor_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_contactvendor_value = n.getStringValue(); },
            "_msdyn_estimate_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_estimate_value = n.getStringValue(); },
            "_msdyn_origin_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_origin_value = n.getStringValue(); },
            "_msdyn_pricelist_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_pricelist_value = n.getStringValue(); },
            "_msdyn_product_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_product_value = n.getStringValue(); },
            "_msdyn_project_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_project_value = n.getStringValue(); },
            "_msdyn_resourcecategory_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_resourcecategory_value = n.getStringValue(); },
            "_msdyn_resourceorganizationalunitid_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_resourceorganizationalunitid_value = n.getStringValue(); },
            "_msdyn_task_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_task_value = n.getStringValue(); },
            "_msdyn_transactioncategory_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_transactioncategory_value = n.getStringValue(); },
            "_msdyn_unit_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_unit_value = n.getStringValue(); },
            "_msdyn_unitschedule_value": (o, n) => { (o as unknown as Msdyn_estimateline)._msdyn_unitschedule_value = n.getStringValue(); },
            "_ownerid_value": (o, n) => { (o as unknown as Msdyn_estimateline)._ownerid_value = n.getStringValue(); },
            "_owningbusinessunit_value": (o, n) => { (o as unknown as Msdyn_estimateline)._owningbusinessunit_value = n.getStringValue(); },
            "_owningteam_value": (o, n) => { (o as unknown as Msdyn_estimateline)._owningteam_value = n.getStringValue(); },
            "_owninguser_value": (o, n) => { (o as unknown as Msdyn_estimateline)._owninguser_value = n.getStringValue(); },
            "_transactioncurrencyid_value": (o, n) => { (o as unknown as Msdyn_estimateline)._transactioncurrencyid_value = n.getStringValue(); },
            "createdby": (o, n) => { (o as unknown as Msdyn_estimateline).createdby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "createdon": (o, n) => { (o as unknown as Msdyn_estimateline).createdon = n.getDateValue(); },
            "createdonbehalfby": (o, n) => { (o as unknown as Msdyn_estimateline).createdonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "exchangerate": (o, n) => { (o as unknown as Msdyn_estimateline).exchangerate = n.getNumberValue(); },
            "importsequencenumber": (o, n) => { (o as unknown as Msdyn_estimateline).importsequencenumber = n.getNumberValue(); },
            "modifiedby": (o, n) => { (o as unknown as Msdyn_estimateline).modifiedby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "modifiedon": (o, n) => { (o as unknown as Msdyn_estimateline).modifiedon = n.getDateValue(); },
            "modifiedonbehalfby": (o, n) => { (o as unknown as Msdyn_estimateline).modifiedonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "msdyn_AccountCustomer": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_AccountCustomer = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_accountingdate": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_accountingdate = n.getDateValue(); },
            "msdyn_AccountVendor": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_AccountVendor = n.getObjectValue<Account>(createAccountFromDiscriminatorValue); },
            "msdyn_amount": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_amount = n.getNumberValue(); },
            "msdyn_amount_base": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_amount_base = n.getNumberValue(); },
            "msdyn_amountmethod": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_amountmethod = n.getNumberValue(); },
            "msdyn_basisamount": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_basisamount = n.getNumberValue(); },
            "msdyn_basisamount_base": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_basisamount_base = n.getNumberValue(); },
            "msdyn_basisprice": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_basisprice = n.getNumberValue(); },
            "msdyn_basisprice_base": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_basisprice_base = n.getNumberValue(); },
            "msdyn_basisquantity": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_basisquantity = n.getNumberValue(); },
            "msdyn_billingtype": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_billingtype = n.getNumberValue(); },
            "msdyn_bookableresource": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_bookableresource = n.getObjectValue<Bookableresource>(createBookableresourceFromDiscriminatorValue); },
            "msdyn_ContactCustomer": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_ContactCustomer = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_ContactVendor": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_ContactVendor = n.getObjectValue<Contact>(createContactFromDiscriminatorValue); },
            "msdyn_customertype": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_customertype = n.getNumberValue(); },
            "msdyn_description": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_description = n.getStringValue(); },
            "msdyn_documentdate": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_documentdate = n.getDateValue(); },
            "msdyn_enddatetime": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_enddatetime = n.getDateValue(); },
            "msdyn_Estimate": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_Estimate = n.getObjectValue<Msdyn_estimate>(createMsdyn_estimateFromDiscriminatorValue); },
            "msdyn_estimateline_Annotations": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_Annotations = n.getCollectionOfObjectValues<Annotation>(createAnnotationFromDiscriminatorValue); },
            "msdyn_estimateline_AsyncOperations": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_AsyncOperations = n.getCollectionOfObjectValues<Asyncoperation>(createAsyncoperationFromDiscriminatorValue); },
            "msdyn_estimateline_BulkDeleteFailures": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_BulkDeleteFailures = n.getCollectionOfObjectValues<Bulkdeletefailure>(createBulkdeletefailureFromDiscriminatorValue); },
            "msdyn_estimateline_DuplicateBaseRecord": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_DuplicateBaseRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_estimateline_DuplicateMatchingRecord": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_DuplicateMatchingRecord = n.getCollectionOfObjectValues<Duplicaterecord>(createDuplicaterecordFromDiscriminatorValue); },
            "msdyn_estimateline_MailboxTrackingFolders": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_MailboxTrackingFolders = n.getCollectionOfObjectValues<Mailboxtrackingfolder>(createMailboxtrackingfolderFromDiscriminatorValue); },
            "msdyn_estimateline_PrincipalObjectAttributeAccesses": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_PrincipalObjectAttributeAccesses = n.getCollectionOfObjectValues<Principalobjectattributeaccess>(createPrincipalobjectattributeaccessFromDiscriminatorValue); },
            "msdyn_estimateline_ProcessSession": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_ProcessSession = n.getCollectionOfObjectValues<Processsession>(createProcesssessionFromDiscriminatorValue); },
            "msdyn_estimateline_SyncErrors": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateline_SyncErrors = n.getCollectionOfObjectValues<Syncerror>(createSyncerrorFromDiscriminatorValue); },
            "msdyn_estimatelineid": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimatelineid = n.getStringValue(); },
            "msdyn_estimateperdaylines": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_estimateperdaylines = n.getStringValue(); },
            "msdyn_exchangeratedate": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_exchangeratedate = n.getDateValue(); },
            "msdyn_msdyn_estimateline_msdyn_estimateline_Origin": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_msdyn_estimateline_msdyn_estimateline_Origin = n.getCollectionOfObjectValues<Msdyn_estimateline>(createMsdyn_estimatelineFromDiscriminatorValue); },
            "msdyn_msdyn_estimateline_msdyn_fact_estimatelineid": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_msdyn_estimateline_msdyn_fact_estimatelineid = n.getCollectionOfObjectValues<Msdyn_fact>(createMsdyn_factFromDiscriminatorValue); },
            "msdyn_numberofresources": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_numberofresources = n.getNumberValue(); },
            "msdyn_Origin": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_Origin = n.getObjectValue<Msdyn_estimateline>(createMsdyn_estimatelineFromDiscriminatorValue); },
            "msdyn_percent": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_percent = n.getNumberValue(); },
            "msdyn_price": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_price = n.getNumberValue(); },
            "msdyn_price_base": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_price_base = n.getNumberValue(); },
            "msdyn_PriceList": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_PriceList = n.getObjectValue<Pricelevel>(createPricelevelFromDiscriminatorValue); },
            "msdyn_Product": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_Product = n.getObjectValue<Product>(createProductFromDiscriminatorValue); },
            "msdyn_Project": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_Project = n.getObjectValue<Msdyn_project>(createMsdyn_projectFromDiscriminatorValue); },
            "msdyn_quantity": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_quantity = n.getNumberValue(); },
            "msdyn_ResourceCategory": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_ResourceCategory = n.getObjectValue<Bookableresourcecategory>(createBookableresourcecategoryFromDiscriminatorValue); },
            "msdyn_ResourceOrganizationalUnitId": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_ResourceOrganizationalUnitId = n.getObjectValue<Msdyn_organizationalunit>(createMsdyn_organizationalunitFromDiscriminatorValue); },
            "msdyn_startdatetime": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_startdatetime = n.getDateValue(); },
            "msdyn_Task": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_Task = n.getObjectValue<Msdyn_projecttask>(createMsdyn_projecttaskFromDiscriminatorValue); },
            "msdyn_TransactionCategory": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_TransactionCategory = n.getObjectValue<Msdyn_transactioncategory>(createMsdyn_transactioncategoryFromDiscriminatorValue); },
            "msdyn_transactionclassification": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_transactionclassification = n.getNumberValue(); },
            "msdyn_transactiontypecode": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_transactiontypecode = n.getNumberValue(); },
            "msdyn_Unit": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_Unit = n.getObjectValue<Uom>(createUomFromDiscriminatorValue); },
            "msdyn_UnitSchedule": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_UnitSchedule = n.getObjectValue<Uomschedule>(createUomscheduleFromDiscriminatorValue); },
            "msdyn_vendortype": (o, n) => { (o as unknown as Msdyn_estimateline).msdyn_vendortype = n.getNumberValue(); },
            "overriddencreatedon": (o, n) => { (o as unknown as Msdyn_estimateline).overriddencreatedon = n.getDateValue(); },
            "ownerid": (o, n) => { (o as unknown as Msdyn_estimateline).ownerid = n.getObjectValue<Principal>(createPrincipalFromDiscriminatorValue); },
            "owningbusinessunit": (o, n) => { (o as unknown as Msdyn_estimateline).owningbusinessunit = n.getObjectValue<Businessunit>(createBusinessunitFromDiscriminatorValue); },
            "owningteam": (o, n) => { (o as unknown as Msdyn_estimateline).owningteam = n.getObjectValue<Team>(createTeamFromDiscriminatorValue); },
            "owninguser": (o, n) => { (o as unknown as Msdyn_estimateline).owninguser = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "statecode": (o, n) => { (o as unknown as Msdyn_estimateline).statecode = n.getNumberValue(); },
            "statuscode": (o, n) => { (o as unknown as Msdyn_estimateline).statuscode = n.getNumberValue(); },
            "timezoneruleversionnumber": (o, n) => { (o as unknown as Msdyn_estimateline).timezoneruleversionnumber = n.getNumberValue(); },
            "transactioncurrencyid": (o, n) => { (o as unknown as Msdyn_estimateline).transactioncurrencyid = n.getObjectValue<Transactioncurrency>(createTransactioncurrencyFromDiscriminatorValue); },
            "utcconversiontimezonecode": (o, n) => { (o as unknown as Msdyn_estimateline).utcconversiontimezonecode = n.getNumberValue(); },
            "versionnumber": (o, n) => { (o as unknown as Msdyn_estimateline).versionnumber = n.getNumberValue(); },
        };
    };
    /**
    ...
    /**
     * Gets the msdyn_estimateline_Annotations property value. 
     * @returns a annotation
     */
    public get msdyn_estimateline_Annotations() {
        return this._msdyn_estimateline_Annotations;
    };
    /**
     * Sets the msdyn_estimateline_Annotations property value. 
     * @param value Value to set for the msdyn_estimateline_Annotations property.
     */
    public set msdyn_estimateline_Annotations(value: Annotation[] | undefined) {
        this._msdyn_estimateline_Annotations = value;
    };
    /**
     * Gets the msdyn_estimateline_AsyncOperations property value. 
     * @returns a asyncoperation
     */
    public get msdyn_estimateline_AsyncOperations() {
        return this._msdyn_estimateline_AsyncOperations;
    };
    /**
     * Sets the msdyn_estimateline_AsyncOperations property value. 
     * @param value Value to set for the msdyn_estimateline_AsyncOperations property.
     */
    public set msdyn_estimateline_AsyncOperations(value: Asyncoperation[] | undefined) {
        this._msdyn_estimateline_AsyncOperations = value;
    };
    /**
     * Gets the msdyn_estimateline_BulkDeleteFailures property value. 
     * @returns a bulkdeletefailure
     */
    public get msdyn_estimateline_BulkDeleteFailures() {
        return this._msdyn_estimateline_BulkDeleteFailures;
    };
    /**
     * Sets the msdyn_estimateline_BulkDeleteFailures property value. 
     * @param value Value to set for the msdyn_estimateline_BulkDeleteFailures property.
     */
    public set msdyn_estimateline_BulkDeleteFailures(value: Bulkdeletefailure[] | undefined) {
        this._msdyn_estimateline_BulkDeleteFailures = value;
    };
    /**
     * Gets the msdyn_estimateline_DuplicateBaseRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_estimateline_DuplicateBaseRecord() {
        return this._msdyn_estimateline_DuplicateBaseRecord;
    };
    /**
     * Sets the msdyn_estimateline_DuplicateBaseRecord property value. 
     * @param value Value to set for the msdyn_estimateline_DuplicateBaseRecord property.
     */
    public set msdyn_estimateline_DuplicateBaseRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_estimateline_DuplicateBaseRecord = value;
    };
    /**
     * Gets the msdyn_estimateline_DuplicateMatchingRecord property value. 
     * @returns a duplicaterecord
     */
    public get msdyn_estimateline_DuplicateMatchingRecord() {
        return this._msdyn_estimateline_DuplicateMatchingRecord;
    };
    /**
     * Sets the msdyn_estimateline_DuplicateMatchingRecord property value. 
     * @param value Value to set for the msdyn_estimateline_DuplicateMatchingRecord property.
     */
    public set msdyn_estimateline_DuplicateMatchingRecord(value: Duplicaterecord[] | undefined) {
        this._msdyn_estimateline_DuplicateMatchingRecord = value;
    };
    /**
     * Gets the msdyn_estimateline_MailboxTrackingFolders property value. 
     * @returns a mailboxtrackingfolder
     */
    public get msdyn_estimateline_MailboxTrackingFolders() {
        return this._msdyn_estimateline_MailboxTrackingFolders;
    };
    /**
     * Sets the msdyn_estimateline_MailboxTrackingFolders property value. 
     * @param value Value to set for the msdyn_estimateline_MailboxTrackingFolders property.
     */
    public set msdyn_estimateline_MailboxTrackingFolders(value: Mailboxtrackingfolder[] | undefined) {
        this._msdyn_estimateline_MailboxTrackingFolders = value;
    };
    /**
     * Gets the msdyn_estimateline_PrincipalObjectAttributeAccesses property value. 
     * @returns a principalobjectattributeaccess
     */
    public get msdyn_estimateline_PrincipalObjectAttributeAccesses() {
        return this._msdyn_estimateline_PrincipalObjectAttributeAccesses;
    };
    /**
     * Sets the msdyn_estimateline_PrincipalObjectAttributeAccesses property value. 
     * @param value Value to set for the msdyn_estimateline_PrincipalObjectAttributeAccesses property.
     */
    public set msdyn_estimateline_PrincipalObjectAttributeAccesses(value: Principalobjectattributeaccess[] | undefined) {
        this._msdyn_estimateline_PrincipalObjectAttributeAccesses = value;
    };
    /**
     * Gets the msdyn_estimateline_ProcessSession property value. 
     * @returns a processsession
     */
    public get msdyn_estimateline_ProcessSession() {
        return this._msdyn_estimateline_ProcessSession;
    };
    /**
     * Sets the msdyn_estimateline_ProcessSession property value. 
     * @param value Value to set for the msdyn_estimateline_ProcessSession property.
     */
    public set msdyn_estimateline_ProcessSession(value: Processsession[] | undefined) {
        this._msdyn_estimateline_ProcessSession = value;
    };
    /**
     * Gets the msdyn_estimateline_SyncErrors property value. 
     * @returns a syncerror
     */
    public get msdyn_estimateline_SyncErrors() {
        return this._msdyn_estimateline_SyncErrors;
    };
    /**
     * Sets the msdyn_estimateline_SyncErrors property value. 
     * @param value Value to set for the msdyn_estimateline_SyncErrors property.
     */
    public set msdyn_estimateline_SyncErrors(value: Syncerror[] | undefined) {
        this._msdyn_estimateline_SyncErrors = value;
    };
    /**
     ...
     */
    public set msdyn_estimatelineid(value: string | undefined) {
        this._msdyn_estimatelineid = value;
    };
    /**
     * Gets the msdyn_estimateperdaylines property value. 
     * @returns a string
     */
    public get msdyn_estimateperdaylines() {
        return this._msdyn_estimateperdaylines;
    };
    /**
     * Sets the msdyn_estimateperdaylines property value. 
     * @param value Value to set for the msdyn_estimateperdaylines property.
     */
    public set msdyn_estimateperdaylines(value: string | undefined) {
        this._msdyn_estimateperdaylines = value;
    };
    /**
    ...
    /**
     * Gets the msdyn_msdyn_estimateline_msdyn_estimateline_Origin property value. 
     * @returns a msdyn_estimateline
     */
    public get msdyn_msdyn_estimateline_msdyn_estimateline_Origin() {
        return this._msdyn_msdyn_estimateline_msdyn_estimateline_Origin;
    };
    /**
     * Sets the msdyn_msdyn_estimateline_msdyn_estimateline_Origin property value. 
     * @param value Value to set for the msdyn_msdyn_estimateline_msdyn_estimateline_Origin property.
     */
    public set msdyn_msdyn_estimateline_msdyn_estimateline_Origin(value: Msdyn_estimateline[] | undefined) {
        this._msdyn_msdyn_estimateline_msdyn_estimateline_Origin = value;
    };
    /**
     * Gets the msdyn_msdyn_estimateline_msdyn_fact_estimatelineid property value. 
     * @returns a msdyn_fact
     */
    public get msdyn_msdyn_estimateline_msdyn_fact_estimatelineid() {
        return this._msdyn_msdyn_estimateline_msdyn_fact_estimatelineid;
    };
    /**
     * Sets the msdyn_msdyn_estimateline_msdyn_fact_estimatelineid property value. 
     * @param value Value to set for the msdyn_msdyn_estimateline_msdyn_fact_estimatelineid property.
     */
    public set msdyn_msdyn_estimateline_msdyn_fact_estimatelineid(value: Msdyn_fact[] | undefined) {
        this._msdyn_msdyn_estimateline_msdyn_fact_estimatelineid = value;
    };
    /**
     ...
     */
    public set msdyn_Origin(value: Msdyn_estimateline | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Annotation>("msdyn_estimateline_Annotations", this.msdyn_estimateline_Annotations);
        writer.writeCollectionOfObjectValues<Asyncoperation>("msdyn_estimateline_AsyncOperations", this.msdyn_estimateline_AsyncOperations);
        writer.writeCollectionOfObjectValues<Bulkdeletefailure>("msdyn_estimateline_BulkDeleteFailures", this.msdyn_estimateline_BulkDeleteFailures);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_estimateline_DuplicateBaseRecord", this.msdyn_estimateline_DuplicateBaseRecord);
        writer.writeCollectionOfObjectValues<Duplicaterecord>("msdyn_estimateline_DuplicateMatchingRecord", this.msdyn_estimateline_DuplicateMatchingRecord);
        writer.writeCollectionOfObjectValues<Mailboxtrackingfolder>("msdyn_estimateline_MailboxTrackingFolders", this.msdyn_estimateline_MailboxTrackingFolders);
        writer.writeCollectionOfObjectValues<Principalobjectattributeaccess>("msdyn_estimateline_PrincipalObjectAttributeAccesses", this.msdyn_estimateline_PrincipalObjectAttributeAccesses);
        writer.writeCollectionOfObjectValues<Processsession>("msdyn_estimateline_ProcessSession", this.msdyn_estimateline_ProcessSession);
        writer.writeCollectionOfObjectValues<Syncerror>("msdyn_estimateline_SyncErrors", this.msdyn_estimateline_SyncErrors);
        writer.writeStringValue("msdyn_estimatelineid", this.msdyn_estimatelineid);
        writer.writeStringValue("msdyn_estimateperdaylines", this.msdyn_estimateperdaylines);
        writer.writeDateValue("msdyn_exchangeratedate", this.msdyn_exchangeratedate);
        writer.writeCollectionOfObjectValues<Msdyn_estimateline>("msdyn_msdyn_estimateline_msdyn_estimateline_Origin", this.msdyn_msdyn_estimateline_msdyn_estimateline_Origin);
        writer.writeCollectionOfObjectValues<Msdyn_fact>("msdyn_msdyn_estimateline_msdyn_fact_estimatelineid", this.msdyn_msdyn_estimateline_msdyn_fact_estimatelineid);
        writer.writeNumberValue("msdyn_numberofresources", this.msdyn_numberofresources);
        writer.writeObjectValue<Msdyn_estimateline>("msdyn_Origin", this.msdyn_Origin);
