...
import {Crmbaseentity, Publisher, Systemuser} from './index';
import {Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Publisheraddress extends Crmbaseentity implements Parsable {
    ...
    /**
     * Instantiates a new publisheraddress and sets the default values.
     */
    public constructor() {
        super();
    };
    ...
    public getFieldDeserializers<T>() : Record<string, (item: T, node: ParseNode) => void> {
        return {...super.getFieldDeserializers<T>(),
            "_createdby_value": (o, n) => { (o as unknown as Publisheraddress)._createdby_value = n.getStringValue(); },
            "_createdonbehalfby_value": (o, n) => { (o as unknown as Publisheraddress)._createdonbehalfby_value = n.getStringValue(); },
            "_modifiedby_value": (o, n) => { (o as unknown as Publisheraddress)._modifiedby_value = n.getStringValue(); },
            "_modifiedonbehalfby_value": (o, n) => { (o as unknown as Publisheraddress)._modifiedonbehalfby_value = n.getStringValue(); },
            "_parentid_value": (o, n) => { (o as unknown as Publisheraddress)._parentid_value = n.getStringValue(); },
            "addressnumber": (o, n) => { (o as unknown as Publisheraddress).addressnumber = n.getNumberValue(); },
            "addresstypecode": (o, n) => { (o as unknown as Publisheraddress).addresstypecode = n.getNumberValue(); },
            "city": (o, n) => { (o as unknown as Publisheraddress).city = n.getStringValue(); },
            "country": (o, n) => { (o as unknown as Publisheraddress).country = n.getStringValue(); },
            "county": (o, n) => { (o as unknown as Publisheraddress).county = n.getStringValue(); },
            "createdby": (o, n) => { (o as unknown as Publisheraddress).createdby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "createdon": (o, n) => { (o as unknown as Publisheraddress).createdon = n.getDateValue(); },
            "createdonbehalfby": (o, n) => { (o as unknown as Publisheraddress).createdonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "fax": (o, n) => { (o as unknown as Publisheraddress).fax = n.getStringValue(); },
            "freighttermscode": (o, n) => { (o as unknown as Publisheraddress).freighttermscode = n.getNumberValue(); },
            "importsequencenumber": (o, n) => { (o as unknown as Publisheraddress).importsequencenumber = n.getNumberValue(); },
            "latitude": (o, n) => { (o as unknown as Publisheraddress).latitude = n.getNumberValue(); },
            "line1": (o, n) => { (o as unknown as Publisheraddress).line1 = n.getStringValue(); },
            "line2": (o, n) => { (o as unknown as Publisheraddress).line2 = n.getStringValue(); },
            "line3": (o, n) => { (o as unknown as Publisheraddress).line3 = n.getStringValue(); },
            "longitude": (o, n) => { (o as unknown as Publisheraddress).longitude = n.getNumberValue(); },
            "modifiedby": (o, n) => { (o as unknown as Publisheraddress).modifiedby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "modifiedon": (o, n) => { (o as unknown as Publisheraddress).modifiedon = n.getDateValue(); },
            "modifiedonbehalfby": (o, n) => { (o as unknown as Publisheraddress).modifiedonbehalfby = n.getObjectValue<Systemuser>(createSystemuserFromDiscriminatorValue); },
            "name": (o, n) => { (o as unknown as Publisheraddress).name = n.getStringValue(); },
            "parentid": (o, n) => { (o as unknown as Publisheraddress).parentid = n.getObjectValue<Publisher>(createPublisherFromDiscriminatorValue); },
            "postalcode": (o, n) => { (o as unknown as Publisheraddress).postalcode = n.getStringValue(); },
            "postofficebox": (o, n) => { (o as unknown as Publisheraddress).postofficebox = n.getStringValue(); },
            "primarycontactname": (o, n) => { (o as unknown as Publisheraddress).primarycontactname = n.getStringValue(); },
            "publisheraddressid": (o, n) => { (o as unknown as Publisheraddress).publisheraddressid = n.getStringValue(); },
            "shippingmethodcode": (o, n) => { (o as unknown as Publisheraddress).shippingmethodcode = n.getNumberValue(); },
            "stateorprovince": (o, n) => { (o as unknown as Publisheraddress).stateorprovince = n.getStringValue(); },
            "telephone1": (o, n) => { (o as unknown as Publisheraddress).telephone1 = n.getStringValue(); },
            "telephone2": (o, n) => { (o as unknown as Publisheraddress).telephone2 = n.getStringValue(); },
            "telephone3": (o, n) => { (o as unknown as Publisheraddress).telephone3 = n.getStringValue(); },
            "timezoneruleversionnumber": (o, n) => { (o as unknown as Publisheraddress).timezoneruleversionnumber = n.getNumberValue(); },
            "upszone": (o, n) => { (o as unknown as Publisheraddress).upszone = n.getStringValue(); },
            "utcconversiontimezonecode": (o, n) => { (o as unknown as Publisheraddress).utcconversiontimezonecode = n.getNumberValue(); },
            "utcoffset": (o, n) => { (o as unknown as Publisheraddress).utcoffset = n.getNumberValue(); },
            "versionnumber": (o, n) => { (o as unknown as Publisheraddress).versionnumber = n.getNumberValue(); },
        };
    };
    /**
     ...
     */
    public set parentid(value: Publisher | undefined) {
    ...
    /**
     * Gets the publisheraddressid property value. 
     * @returns a string
     */
    public get publisheraddressid() {
        return this._publisheraddressid;
    };
    /**
     * Sets the publisheraddressid property value. 
     * @param value Value to set for the publisheraddressid property.
     */
    public set publisheraddressid(value: string | undefined) {
        this._publisheraddressid = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<Publisher>("parentid", this.parentid);
        ...
        writer.writeStringValue("publisheraddressid", this.publisheraddressid);
