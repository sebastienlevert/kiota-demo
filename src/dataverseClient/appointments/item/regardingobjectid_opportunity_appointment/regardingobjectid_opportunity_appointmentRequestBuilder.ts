...
/** Provides operations to manage the regardingobjectid_opportunity_appointment property of the Microsoft.Dynamics.CRM.appointment entity.  */
export class Regardingobjectid_opportunity_appointmentRequestBuilder {
    ...
    /**
     * Instantiates a new Regardingobjectid_opportunity_appointmentRequestBuilder and sets the default values.
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/appointments/{appointment_activityid}/regardingobjectid_opportunity_appointment{?select,expand}";
        const urlTplParams = getPathParameters(pathParameters);
        this.pathParameters = urlTplParams;
        this.requestAdapter = requestAdapter;
    };
    /**
     * Get regardingobjectid_opportunity_appointment from appointments
