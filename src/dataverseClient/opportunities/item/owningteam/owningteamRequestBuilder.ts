...
/** Provides operations to manage the owningteam property of the Microsoft.Dynamics.CRM.opportunity entity.  */
export class OwningteamRequestBuilder {
    ...
    /**
     * Instantiates a new OwningteamRequestBuilder and sets the default values.
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/opportunities/{opportunity_opportunityid}/owningteam{?select,expand}";
        const urlTplParams = getPathParameters(pathParameters);
        this.pathParameters = urlTplParams;
        this.requestAdapter = requestAdapter;
    };
    /**
     * Get owningteam from opportunities
