import {AppointmentCollectionResponse} from '../../../models/microsoft/dynamics/cRM/';
...
/** Provides operations to manage the Opportunity_Appointments property of the Microsoft.Dynamics.CRM.opportunity entity.  */
export class Opportunity_AppointmentsRequestBuilder {
    ...
    /**
     * Instantiates a new Opportunity_AppointmentsRequestBuilder and sets the default values.
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/opportunities/{opportunity_opportunityid}/Opportunity_Appointments{?top,skip,search,filter,count,orderby,select,expand}";
        const urlTplParams = getPathParameters(pathParameters);
        this.pathParameters = urlTplParams;
        this.requestAdapter = requestAdapter;
    };
    /**
     * Get Opportunity_Appointments from opportunities
