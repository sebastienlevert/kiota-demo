...
class NavTogglerComponent extends React.Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
      isNavCollapsed:
  ...
  _renderExpandCollapseNavItem(toggleNavGroups) {
    ...
    const classNames: any = getClassNames(styles, { theme: theme });
...
export const NavToggler = styled(NavTogglerComponent, getStyles as any);
